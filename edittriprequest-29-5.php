...
if($_SESSION['type'] == 'ac'){$WhrUser	=	" id IN(".$v_ids.") ";}
...
if($_SESSION['type'] == 'pa'){
	...
	$wrAC=" AND account IN(".$_SESSION['userdata']['account'].") ";
...
if($_SESSION['type'] == 'cm'){
	...
	$wrAC=" AND casemanager =".$_SESSION['userdata']['cm_id']." ";
...
$Qlocs  = "SELECT * FROM " .  officelocations ." WHERE 1=1 " ;
	if($db->query($Qlocs) && $db->get_num_rows() > 0){	$locsX = $db->fetch_all_assoc(); 	
	 for($i=0;$i<sizeof($locsX);$i++){ $officelocarray[$locsX[$i]['id']]= $locsX[$i]['abrivation']; }
	 } 	 
 $changedlogs='';
...
if($olddata['securedwc']!=$_POST['securedwc']){$changedlogs.='Is it secured wheelchair changed  From [ '.$olddata['securedwc'].' ] To &raquo; [ '.$_POST['securedwc'].' ]<br/>';}
	    ...
	    $Query2  = "UPDATE ".TBL_FORMS." SET $Qr,
		  ...
		  if($db->execute($Query2))
			...
			$Quptripsdetail="UPDATE trip_details SET date					=	'".$appdate."',
													...
													wc						=	'0',
													saccount				=	'".$_POST['destination_account']."',
													location				=	'".$_POST['destination_officelocation']."',
													passenger				=	'".$_POST['passenger']."',
													pre_wait_time			=	'".$_POST['wait_timeA']."'													
				...
				$ptime		= $returnpickup;
					...
					$wc 		= '1';	}	
												...
												$Qrst="date					=	'".$appdate."',
													...
													wc 						= 	'".$wc."',
													trip_remarks			=	'".$comments."',
													pre_wait_time			=	'".$_POST['wait_timeB']."',
													saccount				=	'".$_POST['backto_account']."',
													location				=	'".$_POST['backto_officelocation']."',
				...
				{	
					...
					$wc 		= '1';	
											...
											$Qrst="	date					=	'".$appdate."',
													...
													wc 						= 	'".$wc."',
													pre_wait_time			=	'".$_POST['wait_timeB']."',
													saccount				=	'".$_POST['destination2_account']."',
													location				=	'".$_POST['destination2_officelocation']."',
													ccode					=	'".$_POST['tripnumber']."',
													passenger 				= 	'".$passenger."'";	
			if($pre_triptype=='One Way'){
				...
				{	
					...
					$wc 		= '1';	
							...
							$Qrst=" date					=	'".$appdate."',
													...
													wc 						= 	'".$wc."',
													trip_remarks			=	'".$comments."',
													pre_wait_time			=	'".$_POST['wait_timeC']."',
													saccount				=	'".$_POST['backto_account']."',
													location				=	'".$_POST['backto_officelocation']."',
													ccode					=	'".$_POST['tripnumber']."',
													passenger 				= 	'".$passenger."'";		
				...
				{	
					...
					$wc 		= '1';	
											...
											$Qrst=" date					=	'".$appdate."',
													...
													wc 						= 	'".$wc."',
													pre_wait_time			=	'".$_POST['wait_timeC']."',
													saccount				=	'".$_POST['destination3_account']."',
													location				=	'".$_POST['destination3_officelocation']."',
													ccode					=	'".$_POST['tripnumber']."',
													passenger 				= 	'".$passenger."'";
				...
				{	
					...
					$wc 		= '1';	
											...
											$Qrst=" date					=	'".$appdate."',
													...
													drp_ptime 				= 	'".$drp_ptime."',
													wc 						= 	'".$wc."',
													pre_wait_time			=	'".$_POST['wait_timeD']."',
													saccount				=	'".$_POST['backto_account']."',
													location				=	'".$_POST['backto_officelocation']."',
													ccode					=	'".$_POST['tripnumber']."',
													trip_remarks			=	'".$comments."',
