<?php /* Smarty version 2.6.12, created on 2022-07-22 16:37:57
         compiled from dispatch_report.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'dispatch_report.tpl', 114, false),)), $this); ?>
...
" placeholder="End Date" required="required">								
                        ...
                        <div class="col-sm-3" style="margin-top:20px;">
							<div class="input-group">
                                ...
                                <option value="10" <?php if ($this->_tpl_vars['reqstatus'] == '10'): ?> selected="selected"<?php endif; ?> >Driver Arrived</option>
                                <option value="6" <?php if ($this->_tpl_vars['reqstatus'] == '6'): ?> selected="selected"<?php endif; ?> >Picked Up</option>
                                <option value="4" <?php if ($this->_tpl_vars['reqstatus'] == '4'): ?> selected="selected"<?php endif; ?> >Completed</option>
                                <option value="3" <?php if ($this->_tpl_vars['reqstatus'] == '3'): ?> selected="selected"<?php endif; ?> >Cancelled</option>
                                <option value="7" <?php if ($this->_tpl_vars['reqstatus'] == '7'): ?> selected="selected"<?php endif; ?> >Billable No-Show</option>
                                <option value="8" <?php if ($this->_tpl_vars['reqstatus'] == '8'): ?> selected="selected"<?php endif; ?> >non-Billable No-Show</option>
...
?>
  <tr>
    ...
    <td><?php echo ((is_array($_tmp=$this->_tpl_vars['Requests'][$this->_sections['q']['index']]['date'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
<br/><?php echo ((is_array($_tmp=$this->_tpl_vars['Requests'][$this->_sections['q']['index']]['pck_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%I:%M %p") : smarty_modifier_date_format($_tmp, "%I:%M %p")); ?>
    ...
    <td><a  href="javascript:popWind2('details.php?id=<?php echo $this->_tpl_vars['Requests'][$this->_sections['q']['index']]['tdid']; ?>
