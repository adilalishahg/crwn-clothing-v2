<?php /* Smarty version 2.6.12, created on 2022-07-20 13:10:29
         compiled from onedriver.tpl */ ?>
<html>
<head>
<?php echo '<script> var drv_id =\'';  echo $this->_tpl_vars['dri_code'];  echo '\';</script>'; ?>

<?php echo '<script> var pickadd =\'';  echo $this->_tpl_vars['a'];  echo '\';</script>'; ?>

<?php echo '<script> var dropadd =\'';  echo $this->_tpl_vars['b'];  echo '\';</script>'; ?>

<?php echo '
<meta name="viewport" content="initial-scale=1.0, user-scalable=no">
<script type="text/javascript" src="//maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyBBE53xDKH93kCWSWREyehlzH8N_t2R2lw"></script>
<script language="javascript" type="text/javascript" src="administrator/scripts/jquery-1.2.6.js"></script>
...
function initialize() {
  ...
  var haightAshbury = new google.maps.LatLng(40.0924079,-74.2039007);
  var mapOptions = {
    zoom: 8,
...
<tr>
<td><img src="administrator/images/blank.png" height="25px" width="20" alt="" />&nbsp;</td><td class="lables">&nbsp;</td>
<td><img src="administrator/images/blank.png" height="25px" width="20" alt="" />&nbsp;</td><td class="lables">&nbsp;</td>
<td><img src="administrator/images/blank.png" height="25px" width="20" alt="" />&nbsp;</td><td class="lables">&nbsp;</td></tr>
<tr>
<td><img src="administrator/images/blank.png" height="25px" width="20" alt="" />&nbsp;</td><td class="lables">&nbsp;</td>
<td><img src="administrator/images/blank.png" height="25px" width="20" alt="" />&nbsp;</td><td class="lables">&nbsp;</td>
<td><img src="administrator/images/blank.png" height="25px" width="20" alt="" />&nbsp;</td><td class="lables">&nbsp;</td>
