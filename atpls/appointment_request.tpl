  ...
  <div class="w-container">
    <div class="w-col-12">
      <div class="row contact-wrap" style="padding:0 100 100 100px;"> 
        ...
        {/if}
        <form id="form" method="post" name="uss" action="appointment_request.php" autocomplete="off" enctype="multipart/form-data">
          <div class="row">
          ...
          <div class="form-group col-md-4">
              ...
              <select id="officelocation" class="form-control" name="officelocation" required>
                ...
                <option  value="{$offices[n].id}" {if $offices[n].id eq $post.officelocation} selected {/if}>{$offices[n].abrivation} -- {$offices[n].name}</option>{/section}
            ...
            <input type="text" class="form-control" id="submitter_name" name="submitter_name" value="{$post.submitter_name}" placeholder="Enter Name" maxlength="60">
          	</div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="clientname" name="clientname" value="{$post.clientname}" placeholder="Patient Name"  maxlength="60">
            </div>
            <div class="form-group col-md-4">
              <label for="inputPassword4">Unit/Room #</label>
              <input type="text" class="form-control" id="room_number" name="room_number" value="{$post.room_number}" placeholder="Unit/Room #"  maxlength="40">
            </div>
             <div class="form-group col-md-2">
              <label for="inputCity">Date of Birth</label>
              <input type="text" class="form-control dob" id="dob" name="dob" value="{$post.dob}" placeholder="Date of Birth"  maxlength="10">
            </div>
            <div class="form-group col-md-2">
              <label for="inputState">Patient Weight (bls)</label>
              <input type="text" class="form-control" id="patient_weight" name="patient_weight" value="{$post.patient_weight}" placeholder="Patient Weight"  maxlength="3"  onkeypress="return isNumber(event)" onpaste="return false;" onBlur="vtypechange(this.value)">
            </div>
          </div>
          <div class="row">
          ...
          <div class="form-row">
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control" id="consult_requested" name="consult_requested" value="{$post.consult_requested}" placeholder="Consult Requested" maxlength="200">
            </div>
            <div class="form-group col-md-3">
              <label for="inputCity">Consulting Physician</label>
              <input type="text" class="form-control" id="physician_name" name="physician_name" value="{$post.physician_name}" placeholder="Consulting Physician" maxlength="200">
            </div>
            <div class="form-group col-md-2">
              <label for="inputState">Phone #</label>
              <input type="text" class="form-control phone" id="physician_phone" name="physician_phone" value="{$post.physician_phone}" placeholder="Phone" maxlength="15">
            </div>
            <div class="form-group col-md-4">
              <label for="inputPassword4">Reason</label>
              <textarea class="form-control" id="reason" name="reason" placeholder="Reason" >{$post.reason}</textarea>
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control stenddate" id="appdate_requested" name="appdate_requested" value="{$post.appdate_requested}" placeholder="Appointment Date Requested">
            </div>
            <!--<div class="form-group col-md-3">
              <label for="inputCity">Actual Appointment Date</label>
              <input type="text" class="form-control stenddate" id="appdate" name="appdate" value="{$post.appdate}" placeholder="Actual Appointment Date" maxlength="10">
            </div>-->
            <div class="form-group col-md-3">
              <label for="inputCity">Time</label>
              <input type="text" class="form-control timepicker time" id="apptime" name="apptime" value="{$post.apptime}" placeholder="Time" maxlength="8">
            </div>
            <div class="form-group col-md-6">
              <label for="inputPassword4">Appointment Location/Office Name</label>
              <input type="text" class="form-control" id="appointment_location" name="appointment_location" value="{$post.appointment_location}" placeholder="Appointment Location" maxlength="200">
            </div>
            
            <div class="form-group col-md-6">
              <label for="inputPassword4">Address</label>
              <input type="text" class="form-control" id="autocomplete" name="address" value="{$post.address}" placeholder="Address" maxlength="200">
            </div>
            <div class="form-group col-md-3">
              <label for="inputPassword4">Suite #</label>
             <input type="text" class="form-control" id="suite" name="suite" value="{$post.suite}" placeholder="Suite #" maxlength="50">
            </div>
            <div class="form-group col-md-3">
              <label for="inputPassword4">Telephone</label>
              <input type="text" class="form-control phone" id="phone" name="phone" value="{$post.phone}" placeholder="Phone" maxlength="20">
            </div>
            <div class="form-group col-md-4">
              <label for="inputState">Trip type</label>
              <select id="triptype" class="form-control" name="triptype">
                <option  value="One Way" {if $post.triptype eq 'One Way'} selected {/if}>One Way</option>
                <option  value="Round Trip" {if $post.triptype eq 'Round Trip'} selected {/if}>Round Trip</option>
              </select>
            </div>
            <div class="form-group col-md-4">
              ...
              <select id="vehtype" class="form-control" name="vehtype" onChange="vetype_fun(this.value)">
                <option  value="Ambulatory" {if $post.vehtype eq 'Ambulatory'} selected {/if}>Ambulatory</option>
                <option  value="Wheelchair" {if $post.vehtype eq 'Wheelchair'} selected {/if}>Wheelchair</option>
                <option  value="Non-Medical Stretcher" {if $post.vehtype eq 'Non-Medical Stretcher'} selected {/if}>Non-Medical Stretcher</option>
                <option  value="BLS" {if $post.vehtype eq 'BLS'} selected {/if}>BLS</option>
                <option  value="ALS" {if $post.vehtype eq 'ALS'} selected {/if}>ALS</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              <label for="inputEmail4">Clinical Needs <i class="fa fa-exclamation-circle" style="color:#F00" title="If Oxygen is greater than O3 l/m. Please select BLS Mode of Transportation"></i> (l/m)</label>
              <input type="text" class="form-control" id="clinical_needs" name="clinical_needs" value="{$post.clinical_needs}" placeholder="Clinical Needs" maxlength="4">
            </div>
            <div class="form-group col-md-4">
              ...
              <select id="anticoagulant_therapy" class="form-control" name="anticoagulant_therapy" onChange="anticoagulant_fun(this.value)">
                <option  value="No" {if $post.anticoagulant_therapy eq 'No'} selected {/if}>No</option>
                <option  value="Yes" {if $post.anticoagulant_therapy eq 'Yes'} selected {/if}>Yes</option>
              </select>
              </select>
            </div>
             <div class="form-group col-md-4" style="display:none;" id="needtobeheld_div">
              ...
              <select id="needtobeheld" class="form-control" name="needtobeheld">
                <option  value="No" {if $post.needtobeheld eq 'No'} selected {/if}>No</option>
                <option  value="Yes" {if $post.needtobeheld eq 'Yes'} selected {/if}>Yes</option>
              </select>
            </div>
            
            <div class="form-group col-md-4">
              <label for="inputEmail4"># of Days to Hold Before Appointment</label>
              <input type="text" class="form-control" id="holddays" name="holddays" value="{$post.holddays}" placeholder="# of Days" maxlength="2"  onkeypress="return isNumber(event)" onpaste="return false;" >
            </div>
            <div class="form-group col-md-4">
              <label for="inputState">Does patient need to be NPO prior to appointment?</label>
               <select id="npo_prior" class="form-control" name="npo_prior" onChange="npo_prior_fun(this.value)">
                <option  value="No" {if $post.npo_prior eq 'No'} selected {/if}>No</option>
                <option  value="Yes" {if $post.npo_prior eq 'Yes'} selected {/if}>Yes</option>
              </select>
            </div>
            ...
            <div class="form-group col-md-4" style="display:none;" id="npo_prior_hours_div">
              ...
              <input type="text" class="form-control" id="npo_prior_hours" name="npo_prior_hours" value="{$post.npo_prior_hours}" placeholder="# of Hours"  maxlength="4"  onkeypress="return isNumber2(event)" onpaste="return false;" >
            </div>
            <div class="form-group col-md-4">
              <label for="inputState">Attendant Required?</label>
              <select id="attendant" class="form-control" name="attendant">
                <option  value="No" {if $post.attendant eq 'No'} selected {/if}>No</option>
                <option  value="Yes" {if $post.attendant eq 'Yes'} selected {/if}>Yes</option>
              </select>
            </div>
            </div>
<div class="row">
       ...
       <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="notification_name" name="notification_name" value="{$post.notification_name}" placeholder="Name" maxlength="100">
            </div>
            <div class="form-group col-md-4">
              <label for="inputEmail4">Relationship</label>
              <input type="text" class="form-control" id="notification_relationship" name="notification_relationship" value="{$post.notification_relationship}" placeholder="Relationship" maxlength="100">
            </div>
            <div class="form-group col-md-4">
              <label for="inputEmail4">Phone</label>
              <input type="text" class="form-control phone" id="notification_phone" name="notification_phone" value="{$post.notification_phone}" placeholder="Phone" maxlength="15">
            </div>
         ...
         <div class="form-row" id="question22" style="display:none;">
            <div class="form-group col-md-8">
             ...
             {$post.reason_ambulance}</textarea>
            </div>
          <div class="form-group col-md-4">
              ...
              <select id="bed_confinement" class="form-control" name="bed_confinement" onChange="bed_confinement_fun(this.value)">
                <option  value="No" {if $post.bed_confinement eq 'No'} selected {/if}>No</option>
                <option  value="Yes" {if $post.bed_confinement eq 'Yes'} selected {/if}>Yes</option>
              </select>
            </div>   
            </div>
       ...
       <div class="form-group" >
              <button type="submit" name="submit" id="submit"  value="submit" class="btn btn-primary btn-lg" >Submit Appointment Request</button>
...
{literal}<script>vtypechange('{/literal}{$post.patient_weight}{literal}');</script>{/literal} 
{literal}<script>anticoagulant_fun('{/literal}{$post.anticoagulant_therapy}{literal}');</script>{/literal} 
{literal}<script>npo_prior_fun('{/literal}{$post.npo_prior}{literal}');</script>{/literal} 
{literal}<script>vetype_fun('{/literal}{$post.vehtype}{literal}');</script>{/literal} 
{literal}<script>bed_confinement_fun('{/literal}{$post.bed_confinement}{literal}');</script>{/literal}
