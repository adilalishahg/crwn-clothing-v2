<?php /* Smarty version 2.6.12, created on 2023-01-19 17:04:55
         compiled from vehtpl/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'vehtpl/index.tpl', 121, false),array('modifier', 'wordwrap', 'vehtpl/index.tpl', 125, false),)), $this); ?>
        ...
        <tr>
          <td height="44" colspan="2" align="center"  valign="top"><table width="100%" border="0" class="main_table">
              <tr>
                ...
                <td width="15%" align="center" class="label_txt_heading"><strong>Vehicle ID</strong></td>
                <td width="15%" align="center" class="label_txt_heading"><strong>VIN Number</strong></td>
                <td width="25%" align="center" class="label_txt_heading"><strong>Vehicle Name</strong></td>
...
.</b></td>
                <td align="center" valign="middle"><?php echo $this->_tpl_vars['vehdetails'][$this->_sections['q']['index']]['vehicle_id']; ?>
</td>
                ...
                <td align="center" valign="middle"><?php echo ((is_array($_tmp=$this->_tpl_vars['vehdetails'][$this->_sections['q']['index']]['vname'])) ? $this->_run_mod_handler('wordwrap', true, $_tmp, 30, '<br />
                  ...
                  ', true));  if ($this->_tpl_vars['vehdetails'][$this->_sections['q']['index']]['modiv_flage'] == '1'): ?><br/><img style="margin-top: -11px;" border="0" width="60" height="30" title="ModivCare" alt="ModivCare" src="../graphics/modiv30.svg" /><?php endif; ?></td>
