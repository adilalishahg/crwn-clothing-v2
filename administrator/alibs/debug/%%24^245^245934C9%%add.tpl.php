<?php /* Smarty version 2.6.12, created on 2023-03-31 23:25:29
         compiled from mercytpl/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'mercytpl/add.tpl', 1132, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['appdata'][$this->_sections['q']['index']]['type']; ?>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="appdate" id="appdate" value="<?php if ($this->_tpl_vars['post']['appdate'] != ''):  echo $this->_tpl_vars['post']['appdate'];  else:  echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m/%d/%Y") : smarty_modifier_date_format($_tmp, "%m/%d/%Y"));  endif; ?>" class="required txt_box"  maxlength="15" />
...
" class="required txt_box"  maxlength="8"  onblur="return time(this.id); " size="20"/><!--addaptime();-->
...
" class="txt_box"  maxlength="8"  onblur="return time(this.id);" size="20"/>
...
"  class="txt_box " maxlength="5" onBlur="javascript:time(this.id);" size="20"/>
