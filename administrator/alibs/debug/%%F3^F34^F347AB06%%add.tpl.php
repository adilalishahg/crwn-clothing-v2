<?php /* Smarty version 2.6.12, created on 2023-01-18 15:55:51
...
" maxlength="3" /></td>
                  ...
                  <option value="1" <?php if ($this->_tpl_vars['post']['pick_signature'] == '1'): ?>selected<?php endif; ?>>Yes</option>
                  <option value="0" <?php if ($this->_tpl_vars['post']['pick_signature'] == '0'): ?>selected<?php endif; ?>>No</option>
                  </select></td>
                                  </tr>
                                  <tr>
                  ...
                  <option value="1" <?php if ($this->_tpl_vars['post']['drop_signature'] == '1'): ?>selected<?php endif; ?>>Yes</option>
                  <option value="0" <?php if ($this->_tpl_vars['post']['drop_signature'] == '0'): ?>selected<?php endif; ?>>No</option>
                  </select></td>
                                  </tr><?php endif; ?>  
                                  
                       		<tr id="email" style="display:none--;">
                            <td width="30%" height="25" align="right" class="labeltxt"><strong>Email ID:</strong> </td>
                            <td width="70%" height="25"><input name="email" type="text" class="validate[email]" id="email" value="<?php echo $this->_tpl_vars['post']['email']; ?>
" maxlength="100" />
                            </td>
                            </tr>
                            ...
                            <td width="70%" height="25"><input name="username" type="text" class="validate[]" id="username" value="<?php echo $this->_tpl_vars['post']['username']; ?>
" maxlength="55" />
                            </td>
                            </tr>
                                  <tr id="pass" style="display:none--;">
                                    <td width="30%" height="25" align="right" class="labeltxt"><strong>Password:</strong> </td>
                                    <td width="70%" height="25"><input name="password" type="text" class="validate[]" id="password" value="<?php echo $this->_tpl_vars['post']['password']; ?>
" maxlength="15" />
                                    </td>
                                  </tr>
