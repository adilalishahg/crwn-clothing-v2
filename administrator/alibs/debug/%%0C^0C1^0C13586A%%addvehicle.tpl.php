<?php /* Smarty version 2.6.12, created on 2023-01-19 17:08:16
          ...
          <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><form name="addvehicle" id="addvehicle" method="post" action="addvehicle.php">
              <table width="80%" border="0" cellspacing="2" cellpadding="2" align="center" style="border:#999999 1px solid;">
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input name="vehicle_id" type="text"  class="validate[required] inputTxtField" id="vehicle_id" value="<?php echo $this->_tpl_vars['data']['vehicle_id']; ?>
" maxlength="20"/>
...
" <?php if ($this->_tpl_vars['data']['licensePlateState'] != ''):  if ($this->_tpl_vars['slist'][$this->_sections['n']['index']]['abbr'] == $this->_tpl_vars['data']['licensePlateState']): ?>selected<?php endif;  elseif ($this->_tpl_vars['slist'][$this->_sections['n']['index']]['abbr'] == 'GA'): ?>selected<?php endif; ?>>
