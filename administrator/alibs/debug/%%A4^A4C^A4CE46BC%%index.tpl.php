<?php /* Smarty version 2.6.12, created on 2023-01-18 16:33:58
         compiled from drvtpl/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'drvtpl/index.tpl', 72, false),array('modifier', 'wordwrap', 'drvtpl/index.tpl', 78, false),)), $this); ?>
...
" onblur="byname(this.value);" size="30" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php" ><img alt="Refresh Page" border="0" src="../images/multiple.png" title="Refresh Page"></a> &nbsp;|&nbsp;&nbsp; [<a href="javascript:history.back();">Back</a>]&nbsp;|&nbsp;<a title="Driver Types" href="drvtypes.php">Driver Types</a>&nbsp;<?php if ($_SESSION['driver_quota_message'] == ''): ?>|&nbsp;<a title="Add Driver" href="add-drv.php"><img alt="Add" border="0" src="../graphics/add_12.gif"></a><?php else: ?>
            <a title="Add Driver" href="#" onclick="alert('Your subscription has exceeded the Driver quota limit on allocated tier. Please contact billing to enhance tier limit')"><img alt="Add" border="0" src="../graphics/add_12.gif"></a>
...
.</b></td>
  ...
  <?php if ($this->_tpl_vars['drvdetails'][$this->_sections['q']['index']]['modiv_flage'] == '1'): ?><img style="margin-top: -11px;" border="0" width="60" height="30" title="ModivCare" alt="ModivCare" src="../graphics/modiv30.svg" /><?php endif; ?></td>
