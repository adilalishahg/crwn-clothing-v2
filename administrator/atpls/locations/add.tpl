              ...
              <tr>
                <td height="44" align="center"  valign="top" style="padding-bottom:20px; color: #F00;"><form name="add-admuser" id="add-admuser" method="post" action="">
                    ...
                    <tr>
                      ...
                      <td width="80%" height="25"><input name="location" type="text" class="validate[required]" id="location" value="{$post.location}" maxlength="200" size="50"/>*</td>
                    </tr>
                     <tr>
                      <td  height="25" align="right" class="labeltxt"><b>Address:</b></td>
                      <td  height="25"><input name="address" type="text" class="validate[required]" id="address" value="{$post.address}" maxlength="350"  size="50" />*</td>
                    </tr>
                    <tr>
