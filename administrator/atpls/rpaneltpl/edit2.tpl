...
$('#addtrip').validate();
$("#dobnew").mask("99/99/9999");
$("#d_phnum").mask("(999) 999-9999");
$("#p_phnum").mask("(999) 999-9999");
$("#dobnew").datepicker({ yearRange: "-131:00" ,dateFormat: 'mm/dd/yy'});
});
$(document).ready(function (){
...
{/section}
    ...
    <tr>
      ...
      <td colspan="2" valign="top"><input type="text" name="dob" id="dobnew" {if $dob eq '0000-00-00'} value="" {else} value="{$dob|date_format:"%m/%d/%Y"}" {/if} class="txt_box" maxlength="15" />
        <span class="SmallnoteTxt"> e.g. mm/dd/yyyy</span></td>
      <td></td>
    </tr>
    <tr>
...
<td></td></tr>-->
    ...
    <tr>
      ...
      <td colspan="2"><input type="text" readonly="true" name="appdate" id="appdate" value="{$appdate|date_format:"%m/%d/%Y"}" class="txt_box required" tabindex="23"   />
        <span class="SmallnoteTxt">*  e.g. mm/dd/yyyy</span></td>
    </tr>
    {literal}<script>
function time(t){ 
...
function textalerty(val){
    ...
    <tr>
      ...
      <!-- {$apptime|print_r} -->
      <td colspan="2"><input type="text" name="apptime" id="apptime" value="{$apptime}" class="txt_box required" maxlength="5"  onBlur="javascript:time(this.id)" size="20"/>
                                <!-- <select name="apptimerad" id="apptimerad"  class="form-control" style="width:60px">
                                        <option value="am" {if $apptime|date_format:"%p" eq 'AM' || $apptime|date_format:"%p" eq 'am'} selected{/if}>AM</option>
                                        <option value="pm"  {if $apptime|date_format:"%p" eq 'PM' || $apptime|date_format:"%p" eq 'pm'} selected{/if}>PM</option>
                                      </select> -->
...
<option value="{$p_mad}" {if $p_mad eq 'pm'} selected {/if} >pm</option>
    ...
    <tr>
                      ...
                      <td colspan="2" align="left"><input type="text" name="org_apptime" id="org_apptime" value="{$tripdata.0.org_apptime}" class="required txt_box"  maxlength="5"  onblur="return time(this.id);" size="20"/>
                      <!-- <td colspan="2" align="left"><input type="text" name="org_apptime" id="org_apptime" value="{$tripdata.0.org_apptime|date_format:"%I:%M"}" class="required txt_box"  maxlength="5"  onblur="return time(this.id);" size="20"/> -->
<!-- <select name="org_apptimerad" id="org_apptimerad"  class="form-control" style="width:60px">
<option value="am" {if $tripdata.0.org_apptime|date_format:"%p" eq 'AM' || $tripdata.0.org_apptime|date_format:"%p" eq 'am'} selected{/if}>AM</option>
<option value="pm"  {if $tripdata.0.org_apptime|date_format:"%p" eq 'PM' || $tripdata.0.org_apptime|date_format:"%p" eq 'pm'} selected{/if}>PM</option>
</select> -->
                        &nbsp;<span class="SmallnoteTxt">* (e.g. 15:15 Hrs)</span></td>
                    </tr>
    ...
    <tr id="rpTime" style="display:none;">
      ...
      <td colspan="2"><input type="text" name="returnpickup" id="returnpickup" value="{$returnpickup}" tabindex="26" class="txt_box required" maxlength="5" onBlur="javascript:time(this.id)" size="20"/>
      <!-- <td colspan="2"><input type="text" name="returnpickup" id="returnpickup" value="{$returnpickup|date_format:"%I:%M"}" tabindex="26" class="txt_box required" maxlength="5" onBlur="javascript:time(this.id)" size="20"/> -->
                        <!-- <select name="returnpickuprad" id="returnpickuprad"  class="form-control" style="width:60px">
                        <option value="am" {if $returnpickup|date_format:"%p" eq 'AM' || $returnpickup|date_format:"%p" eq 'am'} selected{/if}>AM</option>               <option value="pm" {if $returnpickup|date_format:"%p" eq 'PM' || $returnpickup|date_format:"%p" eq 'pm'} selected{/if}>PM</option>
                                      </select> -->
...
<td colspan="2"><input maxlength="10" tabindex="15" type="text" name="drpzip" value="{$drpzip}" id="drpzip" class="txt_box  "/>
    ...
    <tr id="three1" style="display:none">
      ...
      <td colspan="2"><input type="text" name="three_pickup" id="three_pickup" value="{$data.0.three_pickup}"  class="txt_box " maxlength="5" onBlur="javascript:time(this.id);" size="20"/>
      <!-- <td colspan="2"><input type="text" name="three_pickup" id="three_pickup" value="{$data.0.three_pickup|date_format:"%I:%M"}"  class="txt_box " maxlength="5" onBlur="javascript:time(this.id);" size="20"/> -->
                        <!-- <select name="three_pickuprad" id="three_pickuprad"  class="form-control" style="width:60px">
                        <option value="am" {if $data.0.three_pickup|date_format:"%p" eq 'AM' || $data.0.three_pickup|date_format:"%p" eq 'am'} selected{/if}>AM</option>
                        <option value="pm" {if $data.0.three_pickup|date_format:"%p" eq 'PM' || $data.0.three_pickup|date_format:"%p" eq 'pm'} selected{/if}>PM</option>
                                      </select> -->
    ...
    <tr id="four1" style="display:none">
      ...
      <td colspan="2"><input type="text" name="four_pickup" id="four_pickup" value="{$data.0.four_pickup}"  class="txt_box " maxlength="5" onBlur="javascript: time(this.id);"  size="20"/>
      <!-- <td colspan="2"><input type="text" name="four_pickup" id="four_pickup" value="{$data.0.four_pickup|date_format:"%I:%M"}"  class="txt_box " maxlength="5" onBlur="javascript: time(this.id);"  size="20"/> -->
                        <!-- <select name="four_pickuprad" id="four_pickuprad"  class="form-control" style="width:60px">
                        <option value="am" {if $data.0.four_pickup|date_format:"%p" eq 'AM' || $data.0.four_pickup|date_format:"%p" eq 'am'} selected{/if}>AM</option>               <option value="pm" {if $data.0.four_pickup|date_format:"%p" eq 'PM' || $data.0.four_pickup|date_format:"%p" eq 'pm'} selected{/if}>PM</option>
                                      </select> -->
        <span class="SmallnoteTxt">*</span>&nbsp;Will Call&nbsp;
