              ...
              <tr>
                <td height="44" align="center"  valign="top" style="padding-bottom:20px; color: #F00;"><form name="add-admuser" id="add-admuser" method="post" action="" enctype="multipart/form-data">
                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                    <td colspan="3" align="center" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">                           <tr>
                     ...
                     <tr>
                      ...
                      <td width="90%" height="25"><input name="title" type="text" class="validate[required]" id="title" value="{$data.title}"  size="100"/>*</td>
                    </tr>
                    <tr>
                      <td width="10%" height="25" align="right" class="labeltxt"><b>Page Name:</b></td>
                      <td width="90%" height="25"><input name="name" type="text" class="validate[required]" id="name" value="{$data.name}"  size="100"/>*</td>
                    </tr>
                    <!-- <tr>
                    ...
                    <tr>
                      ...
                      <td  height="25"> <textarea class="content" id="content" style="width: 100%; height: 500px" name="content" >{$data.content}</textarea></td>
                    </tr>
                                                                                     </table></td>
