...
$("#dob1").datepicker({ yearRange: "-131:00" ,dateFormat: 'mm/dd/yy'});
...
<table width="80%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
  ...
  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      {if $pendingids neq ''}
      <tr >
        <td colspan="2" bgcolor="border-collapse:#000 1px solid;"><form name="search" id="search2" method="post" action="index33.php" >
            <table width="100%" border="0" >
              <tr>
              ...
              <tr>
                <td>&nbsp;
                  <input type="submit" name="submit" value="Delete all searched trips" class="inputButton btn"  />
            ...
            <form name="adduser" id="adduser" method="post" action="index22.php" onSubmit="javascript:load();">
              <table width="80%" border="0" cellspacing="2" cellpadding="2" align="center">
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="dob" id="dob1" {if $data.0.dob eq '0000-00-00'} value="" {else} value="{$data.0.dob|date_format:"%m/%d/%Y"}" {/if} class="txt_box required" />
                    <span class="SmallnoteTxt">*</span>(mm/dd/yyyy)</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="appdate" id="appdate" value="{$data.0.appdate|date_format:"%m/%d/%Y"}" class="required txt_box"  maxlength="15" />
                    &nbsp;<span class="SmallnoteTxt">*</span> <span class="SmallnoteTxt">(mm/dd/yyyy)</span></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="org_apptime" id="org_apptime" value="{$data.0.org_apptime|date_format:"%I:%M"}" class="required txt_box"  maxlength="5"  onblur="return time(this.id);" size="10"/>
                    <select name="org_apptimerad" id="org_apptimerad"  class="form-control" style="width:60px">
                      <option value="am" {if $data.0.org_apptime|date_format:"%p" eq 'AM' || $data.0.org_apptime|date_format:"%p" eq 'am'} selected{/if}>
                      AM
                      </option>
                      <option value="pm"  {if $data.0.org_apptime|date_format:"%p" eq 'PM' || $data.0.org_apptime|date_format:"%p" eq 'pm'} selected{/if}>
                      PM
                      </option>
                    </select>
                    &nbsp;<span class="SmallnoteTxt">* (e.g. 10:30 AM)</span></td>
                </tr>
                <tr>
                  <td align="left" valign="top" class="labels"><strong><span class="label">Pick Time</span>:</strong></td>
                  <td colspan="2" align="left"><input type="text" name="apptime" id="apptime" value="{$data.0.apptime|date_format:"%I:%M"}" class="required txt_box"  maxlength="5"  onblur="return time(this.id);" onKeyUp="ptime(this.value);" size="10"/>
                    <select name="apptimerad" id="apptimerad"  class="form-control" style="width:60px">
                      <option value="am" {if $data.0.apptime|date_format:"%p" eq 'AM' || $data.0.apptime|date_format:"%p" eq 'am'} selected{/if}>
                      AM
                      </option>
                      <option value="pm"  {if $data.0.apptime|date_format:"%p" eq 'PM' || $data.0.apptime|date_format:"%p" eq 'pm'} selected{/if}>
                      PM
                      </option>
                    </select>
                    &nbsp;<span class="SmallnoteTxt">* (e.g. 10:30 AM)</span></td>
                ...
                <tr id="rpTime" style="display:none;">
                  ...
                  <td colspan="2" align="left"><input type="text" name="returnpickup" id="returnpickup" value="{$data.0.returnpickup|date_format:"%I:%M"}"  class="txt_box required " maxlength="5" onBlur="return time(this.id);" size="10"/>
                    <select name="returnpickuprad" id="returnpickuprad"  class="form-control" style="width:60px">
                      <option value="am" {if $data.0.returnpickup|date_format:"%p" eq 'AM' || $data.0.returnpickup|date_format:"%p" eq 'am'} selected{/if}>
                      AM
                      </option>
                      <option value="pm" {if $data.0.returnpickup|date_format:"%p" eq 'PM' || $data.0.returnpickup|date_format:"%p" eq 'pm'} selected{/if}>
                      PM
                      </option>
                    </select>
                    &nbsp;<span class="SmallnoteTxt">* (e.g. 10:30 AM)</span></td>
                ...
                <tr id="three1" style="display:none">
                  ...
                  <td colspan="2"><input type="text" name="three_pickup" id="three_pickup" value="{$data.0.three_pickup|date_format:"%I:%M"}"  class="txt_box " maxlength="5" onBlur="javascript:time(this.id);" size="10"/>
                    <select name="three_pickuprad" id="three_pickuprad"  class="form-control" style="width:60px">
                      <option value="am" {if $data.0.three_pickup|date_format:"%p" eq 'AM' || $data.0.three_pickup|date_format:"%p" eq 'am'} selected{/if}>
                      AM
                      </option>
                      <option value="pm" {if $data.0.three_pickup|date_format:"%p" eq 'PM' || $data.0.three_pickup|date_format:"%p" eq 'pm'} selected{/if}>
                      PM
                      </option>
                    </select>
                ...
                <tr id="four1" style="display:none">
                  ...
                  <td colspan="2"><input type="text" name="four_pickup" id="four_pickup" value="{$data.0.four_pickup|date_format:"%I:%M"}"  class="txt_box " maxlength="5" onBlur="javascript: time(this.id);"  size="10"/>
                    <select name="four_pickuprad" id="four_pickuprad"  class="form-control" style="width:60px">
                      <option value="am" {if $data.0.four_pickup|date_format:"%p" eq 'AM' || $data.0.four_pickup|date_format:"%p" eq 'am'} selected{/if}>
                      AM
                      </option>
                      <option value="pm" {if $data.0.four_pickup|date_format:"%p" eq 'PM' || $data.0.four_pickup|date_format:"%p" eq 'pm'} selected{/if}>
                      PM
                      </option>
                    </select>
                    <span class="SmallnoteTxt">*</span>&nbsp;Will Call&nbsp;
                ...
                <tr id="b1" style="display:none" >
                  ...
                  <td><input name="backto" type="text"  class="txt_box " id="autocomplete3" value="{$bck}" maxlength="150" size="40" />
                    &nbsp;<span class="SmallnoteTxt">*</span></td>
                  <td></td>
                </tr>
                ...
                <tr id="b3" style="display:none;">
                  ...
                  <td colspan="2"><textarea rows="3" cols="40" name="backto_instruction" id="backto_instruction">{$data.0.backto_instruction}</textarea></td>
                </tr>
                {literal} 
...
$(document).ready(function(){	$("#aptmonday, #retmonday, #apttuseday, #rettuseday, #aptwednesday, #retwednesday, #aptthirsday, #retthirsday, #aptfriday, #retfriday, #aptsaturday, #retsaturday, #aptsunday, #retsunday").mask("29:59");
	...
	$("#tdmonday, #tdtuseday, #tdwednesday, #tdthirsday, #tdfriday, #tdsaturday, #tdsunday").mask("99/99/9999");

	$("#tdmonday, #tdtuseday, #tdwednesday, #tdthirsday, #tdfriday, #tdsaturday, #tdsunday").datepicker( {minDate: '0' ,dateFormat: 'mm/dd/yy'} );});
                  ...
                  <td colspan="3"><table width="100%" border="0">
                      ...
                      <tr>
                        <td><input type="checkbox" id="monday" name="monday" onChange="checkrecday(this.id);" {if $Mondaycheck eq '1'}checked{/if}/>
                          &nbsp;Monday</td>
                        <td><input  name="aptmonday" id="aptmonday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'aptmonday');" {if $Mondaycheck eq '1'} value="{$data.0.apptimeM|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="aptmondayrad" id="aptmondayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.apptimeM|date_format:"%p" eq 'AM' || $data.0.apptimeM|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.apptimeM|date_format:"%p" eq 'PM' || $data.0.apptimeM|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input  name="retmonday" id="retmonday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'retmonday');" {if $Mondaycheck eq '1'} value="{$data.0.returnpickupM|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="retmondayrad" id="retmondayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.returnpickupM|date_format:"%p" eq 'AM' || $data.0.returnpickupM|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.returnpickupM|date_format:"%p" eq 'PM' || $data.0.returnpickupM|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input name="tdmonday" id="tdmonday" type="text"  class="appt_txtbox" size="20" maxlength="10" {if $Mondaycheck eq '1'} value="{$tdmonday|date_format:"%m/%d/%Y"}" {else}disabled="disabled"{/if}/></td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" id="tuseday" name="tuseday"  onchange="checkrecday(this.id);" {if $Tuesdaycheck eq '1'}checked{/if}/>
                          &nbsp;Tuesday</td>
                        <td><input  name="apttuseday" id="apttuseday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'apttuseday');" {if $Tuesdaycheck eq '1'} value="{$data.0.apptimeTU|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="apttusedayrad" id="apttusedayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.apptimeTU|date_format:"%p" eq 'AM' || $data.0.apptimeTU|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.apptimeTU|date_format:"%p" eq 'PM' || $data.0.apptimeTU|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input  name="rettuseday" id="rettuseday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'rettuseday');" {if $Tuesdaycheck eq '1'} value="{$data.0.returnpickupTU|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="rettusedayrad" id="rettusedayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.returnpickupTU|date_format:"%p" eq 'AM' || $data.0.returnpickupTU|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.returnpickupTU|date_format:"%p" eq 'PM' || $data.0.returnpickupTU|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input name="tdtuseday" id="tdtuseday" type="text"  class="appt_txtbox" size="20" maxlength="10" {if $Tuesdaycheck eq '1'} value="{$tdtuseday|date_format:"%m/%d/%Y"}" {else}disabled="disabled"{/if}/></td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" id="wednesday" name="wednesday"  onchange="checkrecday(this.id);" {if $Wednesdaycheck eq '1'}checked{/if}/>
                          &nbsp;Wednesday</td>
                        <td><input  name="aptwednesday" id="aptwednesday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'aptwednesday');" {if $Wednesdaycheck eq '1'} value="{$data.0.apptimeW|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="aptwednesdayrad" id="aptwednesdayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.apptimeW|date_format:"%p" eq 'AM' || $data.0.apptimeW|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.apptimeW|date_format:"%p" eq 'PM' || $data.0.apptimeW|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input  name="retwednesday" id="retwednesday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'retwednesday');" {if $Wednesdaycheck eq '1'} value="{$data.0.returnpickupW|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="retwednesdayrad" id="retwednesdayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.returnpickupW|date_format:"%p" eq 'AM' || $data.0.returnpickupW|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.returnpickupW|date_format:"%p" eq 'PM' || $data.0.returnpickupW|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input name="tdwednesday" id="tdwednesday" type="text"  class="appt_txtbox" size="20" maxlength="10" {if $Wednesdaycheck eq '1'} value="{$tdwednesday|date_format:"%m/%d/%Y"}" {else}disabled="disabled"{/if}/></td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" id="thirsday" name="thirsday"  onchange="checkrecday(this.id);" {if $Thursdaycheck eq '1'}checked{/if}/>
                          &nbsp;Thursday</td>
                        <td><input  name="aptthirsday" id="aptthirsday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'aptthirsday');" {if $Thursdaycheck eq '1'} value="{$data.0.apptimeTH|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="aptthirsdayrad" id="aptthirsdayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.apptimeTH|date_format:"%p" eq 'AM' || $data.0.apptimeTH|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.apptimeTH|date_format:"%p" eq 'PM' || $data.0.apptimeTH|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input  name="retthirsday" id="retthirsday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'retthirsday');" {if $Thursdaycheck eq '1'} value="{$data.0.returnpickupTH|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="retthirsdayrad" id="retthirsdayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.returnpickupTH|date_format:"%p" eq 'AM' || $data.0.returnpickupTH|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.returnpickupTH|date_format:"%p" eq 'PM' || $data.0.returnpickupTH|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input name="tdthirsday" id="tdthirsday" type="text"  class="appt_txtbox" size="20" maxlength="10" {if $Thursdaycheck eq '1'} value="{$tdthirsday|date_format:"%m/%d/%Y"}" {else}disabled="disabled"{/if}/></td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" id="friday" name="friday"  onchange="checkrecday(this.id);" {if $Fridaycheck eq '1'}checked{/if}/>
                          &nbsp;Friday</td>
                        <td><input  name="aptfriday" id="aptfriday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'aptfriday');" {if $Fridaycheck eq '1'} value="{$data.0.apptimeF|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="aptfridayrad" id="aptfridayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.apptimeF|date_format:"%p" eq 'AM' || $data.0.apptimeF|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.apptimeF|date_format:"%p" eq 'PM' || $data.0.apptimeF|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input  name="retfriday" id="retfriday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'retfriday');" {if $Fridaycheck eq '1'} value="{$data.0.returnpickupF|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="retfridayrad" id="retfridayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.returnpickupF|date_format:"%p" eq 'AM' || $data.0.returnpickupF|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.returnpickupF|date_format:"%p" eq 'PM' || $data.0.returnpickupF|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input name="tdfriday" id="tdfriday" type="text"  class="appt_txtbox" size="20" maxlength="10" {if $Fridaycheck eq '1'} value="{$tdfriday|date_format:"%m/%d/%Y"}" {else}disabled="disabled"{/if}/></td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" id="saturday" name="saturday"  onchange="checkrecday(this.id);" {if $Saturdaycheck eq '1'}checked{/if}/>
                          &nbsp;Saturday</td>
                        <td><input  name="aptsaturday" id="aptsaturday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'aptsaturday');" {if $Saturdaycheck eq '1'} value="{$data.0.apptimeSA|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="aptsaturdayrad" id="aptsaturdayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.apptimeSA|date_format:"%p" eq 'AM' || $data.0.apptimeSA|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.apptimeSA|date_format:"%p" eq 'PM' || $data.0.apptimeSA|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input  name="retsaturday" id="retsaturday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'retsaturday');" {if $Saturdaycheck eq '1'} value="{$data.0.returnpickupSA|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="retsaturdayrad" id="retsaturdayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.returnpickupSA|date_format:"%p" eq 'AM' || $data.0.returnpickupSA|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.returnpickupSA|date_format:"%p" eq 'PM' || $data.0.returnpickupSA|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input name="tdsaturday" id="tdsaturday" type="text"  class="appt_txtbox" size="20" maxlength="10" {if $Saturdaycheck eq '1'} value="{$tdsaturday|date_format:"%m/%d/%Y"}" {else}disabled="disabled"{/if}/></td>
                      </tr>
                      <tr>
                        <td><input type="checkbox" id="sunday" name="sunday"  onchange="checkrecday(this.id);" {if $Sundaycheck eq '1'}checked{/if}/>
                          &nbsp;Sunday</td>
                        <td><input  name="aptsunday" id="aptsunday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'aptsunday');" {if $Sundaycheck eq '1'} value="{$data.0.apptimeSU|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="aptsundayrad" id="aptsundayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.apptimeSU|date_format:"%p" eq 'AM' || $data.0.apptimeSU|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.apptimeSU|date_format:"%p" eq 'PM' || $data.0.apptimeSU|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input  name="retsunday" id="retsunday" type="text" class="appt_txtbox" maxlength="5" onBlur="return tValid(this.value,'retsunday');" {if $Sundaycheck eq '1'} value="{$data.0.returnpickupSU|date_format:"%I:%M"}" {else}disabled="disabled"{/if}  size="10"/>
                          <select name="retsundayrad" id="retsundayrad"  class="form-control" style="width:60px">
                            <option value="am" {if $data.0.returnpickupSU|date_format:"%p" eq 'AM' || $data.0.returnpickupSU|date_format:"%p" eq 'am'} selected{/if}>
                            AM
                            </option>
                            <option value="pm" {if $data.0.returnpickupSU|date_format:"%p" eq 'PM' || $data.0.returnpickupSU|date_format:"%p" eq 'pm'} selected{/if}>
                            PM
                            </option>
                          </select></td>
                        <td><input name="tdsunday" id="tdsunday" type="text"  class="appt_txtbox" size="20" maxlength="10" {if $Sundaycheck eq '1'} value="{$tdsunday|date_format:"%m/%d/%Y"}" {else}disabled="disabled"{/if}/></td>
                      </tr>
                      <tr>
