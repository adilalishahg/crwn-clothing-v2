        ...
        <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><table width="70%" border="0" class="main_table">
                ...
                {section name=q loop = $vehtypedetails}
				  ...
				  <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
                    ...
                    <td align="center" valign="middle">{$vehtypedetails[q].vehtype}</td>


                    <td align="center" valign="middle">{$vehtypedetails[q].total}</td>
					...
					<a href="editvehtype.php?id={$vehtypedetails[q].id}" title="Edit Vehicle Type" rel="facebox"> 
