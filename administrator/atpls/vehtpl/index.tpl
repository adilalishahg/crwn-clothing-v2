        ...
        <tr>
          <td height="44" colspan="2" align="center"  valign="top"><table width="100%" border="0" class="main_table">
              ...
              <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
                ...
                <td align="center" valign="middle">{$vehdetails[q].vehicle_id}</td>
                <td align="center" valign="middle">{$vehdetails[q].vinn}</td>
                <td align="center" valign="middle">{$vehdetails[q].vname|wordwrap:30:'<br />
                  ':true}{if $vehdetails[q].modiv_flage eq '1'}<br/><img style="margin-top: -11px;" border="0" width="60" height="30" title="ModivCare" alt="ModivCare" src="../graphics/modiv30.svg" />{/if}</td>
