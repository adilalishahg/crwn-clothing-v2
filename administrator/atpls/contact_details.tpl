...
<td height="19" align="center">&nbsp;</td>
  ...
  <tr>
    <td colspan="2" height="25" align="left" class="labeltxt adjust"><b>Hybrid Secret : </b><span style="color:#FF0000">*</span><br /><input name="hybrid_secret" type="text" id="hybrid_secret" value="{$udata[0].hybrid_secret}" size="40" maxlength="50" class="validate[required,custom[],length[0,50]]" /></td>    
  </tr>
  <tr>
    <td colspan="2" height="25" align="left" class="labeltxt adjust"><b>Provider Name : </b><span style="color:#FF0000">*</span><br /><input name="provider_name" type="text" id="provider_name" value="{$udata[0].provider_name}" size="40" maxlength="50" class="validate[required,custom[],length[0,50]]" /></td>    
  </tr>
