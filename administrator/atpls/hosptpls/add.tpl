    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="44" align="center"  valign="top"><form name="adduser" id="adduser" method="post" action="add.php">
              ...
              <td width="38%" align="left" valign="top" class="labels"><strong>Select Program :</strong></td>
			 ...
			 <select name="progtype" class="SelectBox required" id="progtype">
				...
				<option value="0" {if $progtype eq '0'}selected{/if}>Behavioral Health</option>
			   ...
			   {/section}
                ...
                <tr align="left">
                 ...
                 <tr >
                  ...
                  <td><input name="b_aname" type="text"  class="txt_box " id="b_aname" value="{$post.b_aname}" maxlength="150" />
                    &nbsp;<span class="SmallnoteTxt"></span></td>
                  <td></td>
                </tr>
                 <tr >
                  <td class="labels"  >Billing Address:<br/></td>
                  <td><input name="b_address" type="text"  class="txt_box " id="b_address" value="{$post.b_address}" maxlength="150" />
                    &nbsp;<span class="SmallnoteTxt"></span></td>
                  <td></td>
                </tr>
                <tr>
                  <td class="labels" >Billing City:</td>
                  <td><input name="b_city" type="text"  class="txt_box " id="b_city" value="{$post.b_city}" maxlength="150"/>
                    &nbsp;<span class="SmallnoteTxt"></span></td>
                  <td></td>
                </tr>
                <tr>
                  ...
                  <td><select id="b_state" name="b_state"  class="txt_box" />
                    <option value="">Select</option>
                    {section name=n loop=$states}
                    <option value="{$states[n].abbr}"{if $states[n].abbr eq $post.b_state} selected="selected" {else}{if $states[n].abbr eq 'AZ'} selected="selected" {/if}{/if}>
                    {$states[n].statename}
                    </option>
                    {/section}
                    </select>
                ...
                <tr>
                  ...
                  <td><input name="b_zip" type="text"  class="txt_box" id="b_zip" value="{$post.b_zip}" maxlength="10" />
             ...
             <td align="left" valign="top"><input type="text" name="username" id="username" value="{$username}" class="validate[] inputTxtField" maxlength="20" />
                ...
                <tr>
                  ...
                  <td colspan="2" align="left" valign="top"><input type="password" name="pwd1" id="pwd1" class="validate[] inputTxtField" value="{$pwd1}" />
                    &nbsp;</td>
                </tr>
                <tr>
                  <td align="left" valign="top" class="labels"><strong>Confirm Password :</strong></td>
                  <td colspan="2" align="left" valign="top"><input type="password" name="pwd2" id="pwd2" class="validate[] inputTxtField" value="{$pwd2}"  />
                    &nbsp;</td>
                </tr>
                <tr>
