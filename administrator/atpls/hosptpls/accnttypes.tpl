...
function deleteRec(id)
		...
		ok=confirm("Are you sure you want to delete this record? \nAll Account under this type will also be deassociated.");
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">    
      ...
      <tr>
        ...
        <td height="19" align="center"><div align="right" id="add_div" style="padding-right:40px; padding-bottom:5px;"> [<a href="javascript:history.back();">Back</a>]&nbsp;|&nbsp;<a title="Add Account Type" href="addaccnttype.php" rel="facebox"><img alt="Add" border="0" src="../graphics/add_12.gif"></a></a> </div></td>
        ...
        <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><table width="70%" border="0" class="main_table">
                ...
                {section name=q loop = $vehtypedetails}
				  ...
				  <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
					...
					<a href="editaccnttype.php?id={$vehtypedetails[q].id}" title="Edit Account Type" rel="facebox"> 
