...
<td height="19" colspan="2" align="center" class="admintopheading">Generated Trip Sheets</td>
                            </tr>
                            ...
                            <tr>
							 ...
							 <form name="searchReport" action="exp_genrep.php" method="get" id="searchReport"> 
