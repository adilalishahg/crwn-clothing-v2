            ...
            <!--<tr>
               ...
               <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="apptime" id="apptime" value="{$post.apptime}" class="required txt_box"  maxlength="8"  onblur="time(this.id); " size="10"/><!--addaptime();-->
                 ...
                 <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="org_apptime" id="org_apptime" value="{$post.org_apptime}" class="txt_box"  maxlength="8"  onblur="return time(this.id);" size="10"/>
                ...
                <tr id="rpTime" style="display:none;">
                  ...
                  <td colspan="2" align="left"><input type="text" name="returnpickup" id="returnpickup" value="{$post.returnpickup}"  class="txt_box " maxlength="8" onBlur="return time(this.id);" size="10" />
...
{/section}
                ...
                <tr id="three1" style="display:none">
                  ...
                  <td colspan="2"><input type="text" name="three_pickup" id="three_pickup" value="{$post.three_pickup}"  class="txt_box " maxlength="5" onBlur="javascript:time(this.id);" size="10"/>
           ...
           <tr id="four0" style="display:none">
                ...
                <tr id="four1" style="display:none">
                  ...
                  <td colspan="2"><input type="text" name="four_pickup" id="four_pickup" value="{$post.four_pickup}"  class="txt_box " maxlength="5" onBlur="javascript: time(this.id);" size="10"/>
