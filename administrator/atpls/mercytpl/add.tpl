				    ...
				    formvals = fetchedData.split('^'); 
				  	if(formvals.length > 0){
								if(formvals[0] != '')
								  ...
								  $('#dob1').val(formvals[3]);
							  	if(formvals[4] != '')					  
								  $('#claim_no').val(formvals[4]);
							  	if(formvals[5] != '')	$('#patient_weight').val(formvals[5]);
								if(formvals[8] != '')	$('#apptimerad').val(formvals[8]);
								if(formvals[9] != '')	$('#org_apptimerad').val(formvals[9]);
								if(formvals[10] != '')	$('#returnpickuprad').val(formvals[10]);  
								if(formvals[11] != '')	$('#charges').val(formvals[11]); //alert(formvals[11]);
				    ...
				    formvals = fetchedData.split('^'); 
				  	if(formvals.length > 0){
								if(formvals[0] != '')
							  	...
							  	if(formvals[5] != '')	$('#patient_weight').val(formvals[5]);
								if(formvals[8] != '')	$('#apptimerad').val(formvals[8]);
								if(formvals[9] != '')	$('#org_apptimerad').val(formvals[9]);//alert(formvals[9]);
								if(formvals[10] != '')	$('#returnpickuprad').val(formvals[10]);  
								if(formvals[11] != '')	$('#charges').val(formvals[11]); //alert(formvals[11]);
							   	if(formvals[15] != '')  $('#autocomplete').val(formvals[15]); 	 						  
						  		if(formvals[19] != '')	$('#autocomplete2').val(formvals[19]); 						  
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
           <td height="25" align="right" valign="top">
            ...
            <a href="logistic.php" rel="facebox">ModiVCare
            ...
            <!--<tr>
               ...
               <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="appdate" id="appdate" value="{if $post.appdate neq ''}{$post.appdate}{else}{$smarty.now|date_format:"%m/%d/%Y"}{/if}" class="required txt_box"  maxlength="15" />
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="apptime" id="apptime" value="{$post.apptime}" class="required txt_box"  maxlength="8"  onblur="return time(this.id); " size="20"/><!--addaptime();-->
                   <!-- <select name="apptimerad" id="apptimerad"  style="width:60px">
                 ...
                 <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="org_apptime" id="org_apptime" value="{$post.org_apptime}" class="txt_box"  maxlength="8"  onblur="return time(this.id);" size="20"/>
                ...
                <tr id="rpTime" style="display:none;">
                  ...
                  <td colspan="2" align="left"><input type="text" name="returnpickup" id="returnpickup" value="{$post.returnpickup}"  class="txt_box " maxlength="8" onBlur="return time(this.id);" size="20" />
...
{/section}
                ...
                <tr id="three1" style="display:none">
                  ...
                  <td colspan="2"><input type="text" name="three_pickup" id="three_pickup" value="{$post.three_pickup}"  class="txt_box " maxlength="5" onBlur="javascript:time(this.id);" size="20"/>
           ...
           <tr id="four0" style="display:none">
                ...
                <tr id="four1" style="display:none">
                  ...
                  <td colspan="2"><input type="text" name="four_pickup" id="four_pickup" value="{$post.four_pickup}"  class="txt_box " maxlength="5" onBlur="javascript: time(this.id);" size="20"/>
...
$(document).ready(function(){
	$("#aptmonday, #retmonday, #apttuseday, #rettuseday, #aptwednesday, #retwednesday, #aptthirsday, #retthirsday, #aptfriday, #retfriday, #aptsaturday, #retsaturday, #aptsunday, #retsunday").mask("19:59");
	$("#tdmonday, #tdtuseday, #tdwednesday, #tdthirsday, #tdfriday, #tdsaturday, #tdsunday").mask("19/39/9999");
...
function checkrecday(feildid){
	if($('#'+feildid).attr('checked')){
		...
		var apptimerad = $('#apptimerad').val();  			$('#apt'+feildid+'rad').val(apptimerad); 
		var returnpickuprad = $('#returnpickuprad').val(); 	$('#ret'+feildid+'rad').val(returnpickuprad);  
		}
	else {
                  ...
                  <td colspan="3"><table width="100%" border="0" id="recc" style="display:none;">
                      ...
                      <tr>
                        <td><input type="checkbox" id="monday" name="monday" onChange="checkrecday(this.id);" />
                          &nbsp;Monday</td>
                        <td><input  name="aptmonday" id="aptmonday" type="text" class="appt_txtbox"  maxlength="8" onBlur="return tValid(this.value,'aptmonday');" disabled="disabled" size="10"/>
                                <select name="aptmondayrad" id="aptmondayrad"  class="form-control" style="width:60px">
                                        <option value="am">AM</option>
                                        <option value="pm">PM</option>
                                      </select></td>
                        <td><input  name="retmonday" id="retmonday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'retmonday');" disabled="disabled" size="10"/>
                      ...
                      <tr>
                        <td><input type="checkbox" id="tuseday" name="tuseday"  onchange="checkrecday(this.id);" />
                          &nbsp;Tuesday</td>
                        <td><input  name="apttuseday" id="apttuseday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'apttuseday');" disabled="disabled" size="10"/>
                                <select name="apttusedayrad" id="apttusedayrad"  class="form-control" style="width:60px">
                                        <option value="am">AM</option>
                                        <option value="pm">PM</option>
                                      </select></td>
                        <td><input  name="rettuseday" id="rettuseday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'rettuseday');" disabled="disabled" size="10"/>
                      ...
                      <tr>
                        <td><input type="checkbox" id="wednesday" name="wednesday"  onchange="checkrecday(this.id);" />
                          &nbsp;Wednesday</td>
                        <td><input  name="aptwednesday" id="aptwednesday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'aptwednesday');" disabled="disabled" size="10"/>
                                <select name="aptwednesdayrad" id="aptwednesdayrad"  class="form-control" style="width:60px">
                                        <option value="am">AM</option>
                                        <option value="pm">PM</option>
                                      </select></td>
                        <td><input  name="retwednesday" id="retwednesday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'retwednesday');" disabled="disabled" size="10"/>
                      ...
                      <tr>
                        <td><input type="checkbox" id="thirsday" name="thirsday"  onchange="checkrecday(this.id);" />
                          &nbsp;Thursday</td>
                        <td><input  name="aptthirsday" id="aptthirsday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'aptthirsday');" disabled="disabled" size="10"/>
                                <select name="aptthirsdayrad" id="aptthirsdayrad"  class="form-control" style="width:60px">
                                        <option value="am">AM</option>
                                        <option value="pm">PM</option>
                                      </select></td>
                        <td><input  name="retthirsday" id="retthirsday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'retthirsday');" disabled="disabled" size="10"/>
                      ...
                      <tr>
                        <td><input type="checkbox" id="friday" name="friday"  onchange="checkrecday(this.id);" />
                          &nbsp;Friday</td>
                        <td><input  name="aptfriday" id="aptfriday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'aptfriday');" disabled="disabled" size="10"/>
                                <select name="aptfridayrad" id="aptfridayrad"  class="form-control" style="width:60px">
                                        <option value="am">AM</option>
                                        <option value="pm">PM</option>
                                      </select></td>
                        <td><input  name="retfriday" id="retfriday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'retfriday');" disabled="disabled" size="10"/>
                      ...
                      <tr>
                        <td><input type="checkbox" id="saturday" name="saturday"  onchange="checkrecday(this.id);" />
                          &nbsp;Saturday</td>
                        <td><input  name="aptsaturday" id="aptsaturday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'aptsaturday');" disabled="disabled" size="10"/>
                                <select name="aptsaturdayrad" id="aptsaturdayrad"  class="form-control" style="width:60px">
                                        <option value="am">AM</option>
                                        <option value="pm">PM</option>
                                      </select></td>
                        <td><input  name="retsaturday" id="retsaturday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'retsaturday');" disabled="disabled" size="10"/>
                       ...
                       <tr>
                        <td><input type="checkbox" id="sunday" name="sunday"  onchange="checkrecday(this.id);" />
                          &nbsp;Sunday</td>
                        <td><input  name="aptsunday" id="aptsunday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'aptsunday');" disabled="disabled" size="10"/>
                                <select name="aptsundayrad" id="aptsundayrad"  class="form-control" style="width:60px">
                                        <option value="am">AM</option>
                                        <option value="pm">PM</option>
                                      </select></td>
                        <td><input  name="retsunday" id="retsunday" type="text" class="appt_txtbox" maxlength="8" onBlur="return tValid(this.value,'retsunday');" disabled="disabled" size="10"/>
