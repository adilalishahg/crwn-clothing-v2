              ...
              <tr>
                <td height="44" align="center"  valign="top" style="padding-bottom:20px; color: #F00;"><form name="add-admuser" id="add-admuser" method="post" action="" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <td width="90%" height="25"><input name="question" type="text" class="validate[required]" id="question" value="{$post.question}"  size="100"/>*</td>
                    </tr>
                    <!-- <tr>
                    ...
                    <tr>
                      ...
                      <td  height="25"> <textarea class="content" id="content" style="width: 100%; height: 500px" name="answer" >{$post.answer}</textarea></td>
                    </tr>
                                                                                     </table></td>
