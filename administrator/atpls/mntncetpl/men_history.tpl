  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">        
        ...
        <tr>
          ...
          <td height="19" align="center"><div align="right" id="add_div" style="padding-right:40px; padding-bottom:5px;">[<a href="index.php">Manage Maintenance</a>] | [<a href="javascript:history.back();">Back</a>]</div></td>
        ...
        <tr>
          ...
          <td height="19" align="center" class="admintopheading">MAINTENANCE HISTORY - [{$vehicle.vname} - {$vehicle.vnumber} ]</td>
        ...
        <tr>
          ...
          <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><table width="100%" border="0" class="main_table">
              ...
              <tr>
                ...
                <td width="20%" align="center" class="label_txt_heading"><strong>Maintenance Type</strong></td>

                <td align="center" class="label_txt_heading"><strong>Maintenance Descripition</strong></td>

                <td width="15%" align="center" class="label_txt_heading"><strong>Status</strong></td>

                <td width="15%" align="center" class="label_txt_heading"><strong>Cost</strong></td>
              ...
              <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
                ...
                <td align="center" valign="middle">{$data[q].m_type}</td>
