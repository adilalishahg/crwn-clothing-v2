...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
							  ...
							  <form name="edit-admuser" id="edit-admuser" method="post" action="edituser.php?eId={$eId}">
  ...
  <tr>
    ...
    <td width="70%" height="25"><input name="admname" type="text" class="validate[required,custom[onlyLetter]]" id="admname" value="{$admname}" maxlength="15" /> 
    ...
    *</td>
    ...
    <td width="70%" height="25"><input name="lname" type="text" class="validate[required,custom[onlyLetter]]" id="lname" value="{$lname}" maxlength="15" /> 
  ...
  <tr>
    ...
    <td height="25"><input name="admuname" type="text" id="admuname" value="{$admuname}" class="validate[required,custom[noSpecialCaracters]]" maxlength="15"/> 
    ...
    *</td>
      ...
      <tr>
        ...
        <tr>
          ...
          <td width="387" align="left" valign="top"><input type="hidden" name="hidstatus" id="hidstatus" value="{$hidstatus}" />
