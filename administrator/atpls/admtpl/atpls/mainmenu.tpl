...
<div id="dropmenu1" class="dropmenudiv" style="width: 150px;">
  ...
  <a href="corporate/">Manage</a>

  <a href="corporate/add.php">Add Corporation</a>   
...
<div id="dropmenu5" class="dropmenudiv" style="width: 150px;">
    ...
    <a href="orders/vieworders.php">View Orders</a>

    <a href="orders/vieworders.php?status=pending">Pending Orders</a>

	<a href="orders/vieworders.php?status=completed">Completed Orders</a>

	<a href="orders/vieworders.php?status=shipped">Shipped Orders</a>
