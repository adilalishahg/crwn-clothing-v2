          ...
          <td height="44" align="left"  valign="top" style="padding-bottom:50px;"><form name="editvehicle" id="editvehicle" method="post" action="timeout.php">
              <table width="90%" border="0" cellspacing="2" cellpadding="2" align="center" class="outer_table">
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input name="date" type="text"  class="inputTxtField required" id="date" value="{$user[0].date}" readonly="readonly"/>                    <span class="SmallnoteTxt">*&nbsp;(mm/dd/yyyy)</span></td>
                </tr>
                <tr>
                  <td align="left" valign="top" class="labeltxt"><strong>Time In :</strong></td>
                  <td colspan="2" align="left"><input name="in" type="text"  class="inputTxtField required" id="in" value="{$user[0].time_in}" maxlength="50" readonly="readonly"/>                    
			  ...
			  <select name="driver" id="driver" class="SelectBox required" >
			   ...
			   {/section}
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><input name="out" type="text"  class="inputTxtField required" id="out" value="{$time}" maxlength="8"/>                    
                  <span class="SmallnoteTxt">*&nbsp;(hh:mm:ss) </span></td>
                </tr>
                <tr>
                  <td align="left" valign="top" class="labeltxt"><strong>End Mileage: </strong></td>
                  <td colspan="2" align="left"><input type="text" name="emileage" id="emileage"  /></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td valign="top">&nbsp;</td>
                  <td colspan="2"><input type="submit" name="timeout" value="Update" class="inputButton" id="timeout"></td>
                </tr><input type="hidden" name="id" value="$id"  id="id">
              </table>
          </form></td>
        </tr>
        <tr>
