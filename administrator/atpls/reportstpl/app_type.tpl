            ...
            <table width="85%" border="0" class="main_table">
              <tr class="admintopheading">
                <td width="20%" align="center"><strong>Patient Name</strong> 
                  ...
                  <!--<strong>{if $showPatient eq 'no'}Facility{else}Consumer Name{/if}</strong>
--></td>
              ...
              <tr id="tr{$reqdetails[q].id}" bgcolor="{cycle values="#ffffff,#dfedfa"}">
                <td align="left" valign="middle"><b>{if $showPatient eq 'no'}{$reqdetails[q].hospname}{else}{$reqdetails[q].clientname}{/if}</b></td>
