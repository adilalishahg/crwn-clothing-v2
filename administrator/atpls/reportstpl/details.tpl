...
<tr><td colspan="6" style="height:20px;"></td></tr>
<tr><td width="140" class="headus">Patient Name:</td><td class="val">{$data.0.clientname}</td><td width="140" class="headus">Account Name:</td><td class="val">{$data.0.account_name}</td><td width="140" class="headus">Trip Type:</td><td width="140" class="val">{$data.0.triptype}</td></tr>
...
<tr><td width="140" class="headus">Patient Phone #:</td><td width="140" class="val">{$data.0.phnum}</td><td width="140" class="headus">Service Needed:</td><td width="140" class="val" colspan="3">{$vehtype}  [{if $data.0.vehicle_name neq ''} {$data.0.vehicle_name}{/if} {if $data.0.vehicle_id neq ''}  --  {$data.0.vehicle_id}{/if}]</td></tr>
...
<tr>
              ...
              <td height="25"  align="left" class="labeltxt">{$data.0.tripassign_time} [ {$data.0.tripassign_time|date_format} ]</td>
              <td height="25"  align="left" class="labeltxt">Driver Confirmation Time: </td>
              <td height="25"  align="left" class="labeltxt">{$data.0.driverconfirm_time}</td>
            </tr>
            <tr>
              <td height="25"  align="left" class="labeltxt">Driver Arrival Time: </td>
              <td height="25"  align="left" class="labeltxt">{$data.0.arrived_time}</td>
            ...
            <tr>
              ...
              <td height="25"  align="left" class="labeltxt">{if $data[0].pck_time eq '23:59:59'}Will Call{else}{$data[0].pck_time}{/if}</td>
              <td height="25"  align="left" class="labeltxt">Actual Picked Time: </td>
              <td height="25"  align="left" class="labeltxt">{if $data[0].aptime!='00:00:00'}{$data[0].aptime}{else}{'00:00:00'}{/if}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td height="25"  align="left" class="labeltxt">{if $data[0].drp_atime!='00:00:00'}{$data[0].drp_atime}{else}{'00:00:00'}{/if}</td>
            </tr>
            <tr>
