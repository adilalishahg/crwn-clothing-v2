...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><form name="ar" id="ar" method="post" action="">
        <table width="100%" border="0" cellspacing="4" cellpadding="2" align="center" class="">
          ...
          <tr>
            ...
            <tr> 
             ...
             <td  align="left">$<input type="text" name="charges[]" value="{$billingdata[q].charges}" readonly="readonly"/>
