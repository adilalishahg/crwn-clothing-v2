        ...
        <tr>
          <td height="44" colspan="2" align="center"  valign="top" style="padding-bottom:50px;"><table width="100%" border="0" class="main_table11">
              ...
              <tr id="tr{$reqdetails[q].id}" bgcolor="{cycle values="#ffffff,#dfedfa"}">
                ...
                <td align="center" valign="top"><p>{$data[q].trip_user}</p>{if $data[q].modiv_id neq ''}<img style="margin-top: -11px;" border="0" width="60" height="30" title="ModivCare" alt="ModivCare" src="../graphics/modiv30.svg" />{/if}</td>
                ...
                <td align="center" valign="top">{$data[q].date}<br/><span style="color:#F00;">{$data[q].ccode} {$data[q].modiv_id}</span></td>
               ...
               <!-- <td align="center" valign="top"><div class="rating1" style="width:60px;"  title="{$data[q].comments}">{if $data[q].drv_rating gt 0}
                    ...
                    {/if}</div></td>-->
                <td align="center" valign="top">
                <a href="#" onclick="window.open('edit_trip.php?tdid={$data[q].tdid}')" title="Edit"> <img border="0" alt="Edit" src="../graphics/edit.png"></a><br/>
