                          ...
                          {if $noReq neq '0'}
						   ...
						   <br />
							  ...
							  <tr class="admintopheading">
								...
								<strong>{if $showPatient eq 'no'}Facility.{else}Facility Name{/if}</strong>

								</td>

								<td width="15%" align="center">

								<strong>{if $showPatient eq 'no'}Contact Person{else}Appointment Date/Time{/if} </strong>
							   ...
							   <td  width="15%"  align="center" ><strong>Pick Address</strong></td>
								...
								<strong>{if $showPatient eq 'no'}Requests Date{else}Date of Birth{/if}</strong>
