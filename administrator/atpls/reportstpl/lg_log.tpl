    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="44" colspan="2" align="center"  valign="top" style="padding-bottom:50px;"><table width="100%" border="0" class="main_table">
              ...
              {if $data[q].rows neq '0'}
              <tr id="tr{$data[q].tdid}" bgcolor="{cycle values="#ffffff,#dfedfa"}">
                <!--<td align="center" valign="top">{$data[q].tdid}</td>-->
                <td align="center" valign="top">{$data[q].tdid}</td>
                <td align="center" valign="top">{$data[q].trip_user}</td>
                <!--<td align="center" valign="top">
                {if $data[q].type eq 'AB'}T{/if}
                {if $data[q].type eq 'BF'}F{/if}</td>-->
                <td align="center" valign="top">{if $data[q].pck_time eq '00:00:00'}--:--{else}{$data[q].pck_time|date_format:"%H:%M"}{/if}</td>
                <td align="center" valign="top">{if $data[q].aptime eq '00:00:00'}--:--{else}{$data[q].aptime|date_format:"%H:%M"}{/if}</td>
                <td align="center" valign="top">{if $data[q].drp_atime eq '00:00:00'}--:--{else}{$data[q].drp_atime|date_format:"%H:%M"}{/if}</td>
