...
function enable(){
 ...
 var field=document.getElementById('portfolio').checked;
 
 if(field){
	var field2=document.getElementById('portfolio_title');
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                            <tr>
                              <td height="25" align="right" valign="top" style="padding-right:10px;">[<a href="javascript:history.back();">Back</a>]</td>
                            </tr>
...
<td height="19" align="center" >&nbsp;</td>
                            ...
                            <tr>
							  ...
							  <form name="affregister" id="affregister" method="post" action="addphysician.php" enctype="multipart/form-data">
	  <table width="100%" border="0" cellspacing="2" cellpadding="2">
        ...
        <tr>
          <td colspan="3" align="left" valign="top" class="admintopheading"><strong>Add Physician: </strong></td>
          </tr>
        <tr>
  ...
  <tr>
    <td height="25" align="right" class="labeltxt">Specialities: </td>
    <td height="25"><select name="pspecialities" id="pspecialities" style="width:250px;">
	<option value="">SELECT</option>
	{section name=q loop=$category}
	<option value="{$category[q].id}">{$category[q].category}</option>
	{/section}
	</select>
	</td>
  </tr>
 ...
 <!-- <tr>
  ...
  <tr>
    <td height="25" align="right" class="labeltxt">Address: <span style="color:#FF0000">*</span> </td>
     <td><input name="baddress" type="text" class="required" id="baddress" maxlength="100" value="{$baddress}"/>       </td>
  </tr>-->
  <tr>
  ...
  <span class="labeltxt">UnPublished</span></td>
      ...
      <tr>
        ...
        <tr>
          ...
          <input type="submit" name="addtestimonials" id="addtestimonials" value="Add Physician" class="btn" />
