              ...
              <tr>
                <td height="44" align="center"  valign="top" style="padding-bottom:20px;"><table width="100%" border="0" class="main_table">
                    ...
                    <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
                      ...
                      <td align="left" valign="middle">{$admdetail[q].email}</td>
                      <td align="left" valign="middle">
                      {if $admdetail[q].id eq $logiticid}<a href="../rate_management2/index.php?id={$admdetail[q].id}"><span style="color:#F00;">Manage</span></a>{else}
                      <a href="../rate_management/index.php?id={$admdetail[q].id}"><span style="color:#F00;">Manage</span></a>{/if}</td>
