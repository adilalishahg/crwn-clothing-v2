          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <option value="{$states[n].abbr}" {if $states[n].abbr eq $data.state}selected{elseif $states[n].abbr eq 'AZ'}selected{/if}>
			   ...
			   {/section}
                  ...
                  <option value="1" {if $data.pick_signature eq '1'}selected{/if}>Yes</option>
                  <option value="0" {if $data.pick_signature eq '0'}selected{/if}>No</option>
                  </select></td>
                                  </tr>
                                  <tr>
                  ...
                  <option value="1" {if $data.drop_signature eq '1'}selected{/if}>Yes</option>
                  <option value="0" {if $data.drop_signature eq '0'}selected{/if}>No</option>
                  </select></td>
                                  </tr>{/if}
                                <!-- <tr>
                  ...
                  <option value="flat" {if $data.rate_type eq 'flat'}selected{/if}>Flat Rate</option>
                            ...
                            <td width="70%" height="25"><input name="email" type="text" class="validate[email]" id="email" value="{$data.email}" maxlength="100" />
                            </td>
                            </tr>
                            ...
                            <td width="70%" height="25">
                              ...
                              <option value="1" {if $data.portal_access eq 1}selected{/if}>Yes</option>
                              <option value="0" {if $data.portal_access eq 0}selected{/if}>No</option>
                              </select>
                            </td>
                            </tr>
                                  <tr id="uname" style="display:none--;">
                                  <td width="30%" height="25" align="right" class="labeltxt"><strong>User Name:</strong> </td>
                                  <td width="70%" height="25"><input name="username" type="text" class="validate[]" id="username" value="{$data.username}" maxlength="55" />
                                  </td>
                                  </tr>
                                  <tr id="pass" style="display:none--;">
                                    <td width="30%" height="25" align="right" class="labeltxt"><strong>Password:</strong> </td>
                                    <td width="70%" height="25"><input name="password" type="text" class="validate[]" id="password" value="{$data.password}" maxlength="15" />
                                    </td>
                                  </tr>
