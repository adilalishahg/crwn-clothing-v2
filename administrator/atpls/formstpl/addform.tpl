...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                            ...
                            <tr>
                              <td height="19" align="center" class="admintopheading">ADD BROCHURE/FORM</td>
                            </tr>
...
<td height="19" align="center" >&nbsp;</td>
                            ...
                            <tr>
							 ...
							 <form name="affregister" id="affregister" method="post" action="addform.php" enctype="multipart/form-data" onsubmit="return validate(this);">
  ...
  <tr>
    <td height="25" align="right" class="labeltxt" style="vertical-align:top;"><strong>Description : <span style="color:#F00">*</span></strong></td>
    <td height="25" colspan="4" valign="middle"><textarea name="editor1" id="editor1" cols="145" rows="5">{$description}</textarea>{if $msgs neq ''}<font color="#FF0000" style="font-weight:bold; font-family:Arial, Helvetica, sans-serif;" >{$msgs}</font>{/if}
	{literal}
...
{/literal}</td>
  ...
  <tr>
    <td width="24%" height="25" align="right" class="labeltxt"><strong>Document : <span style="color:#F00">*</span></strong></td>
    <td height="40" colspan="4"><input type="file" style="height:25px;" name="upd_img[]" id="upd_img" class="validate[required]" />&nbsp;(<span style="color:#FF0000; font-size:9px; font-weight:bold;">.pdf,.doc,.docx,.xls,.xlsx,.ppt,.jpg</span>)</td>
  </tr>
  <tr>
    <td height="25" align="right" class="labeltxt"><strong>Status : </strong></td>
   <td width="5%" height="25"><input name="status" type="radio" id="status"  value="1" {if $status eq '1'}checked{/if} /></td>
   <td width="10%"><span class="labeltxt">Published</span></td>
   <td width="4%"><input name="status" type="radio" id="radio" value="0" {if $status eq '0'}checked{/if} /></td>
   <td width="57%"><span class="labeltxt">Un-Published</span></td>
   </tr>
      ...
      <tr>
        ...
        <tr>
		  ...
		  <input type="submit" name="addtestimonials" id="addtestimonials" value="Add Brochure/Form" class="btn" />
