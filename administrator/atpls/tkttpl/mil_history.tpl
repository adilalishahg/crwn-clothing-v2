  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td height="19" align="center" class="admintopheading">MILEAGE HISTORY - [{$vehicle.vname} - {$vehicle.vnumber} ]</td>
        ...
        <tr>
          ...
          <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><table width="100%" border="0" class="main_table">
              ...
              <tr>
                ...
                <td width="5%" align="center" class="labeltxt"><strong>S.no.</strong></td>
...
<!--                <td width="20%" align="center" class="labeltxt"><strong>Vehicle Number</strong></td>
                ...
                <td width="25%" align="center" class="labeltxt"><strong>Trip Consumer</strong></td>

                <td width="20%" align="center" class="labeltxt"><strong>Trip Corporation</strong></td>

                <td width="15%" align="center" class="labeltxt"><strong>Pick up Address</strong></td>

                <td width="15%" align="center" class="labeltxt"><strong>Drop Address</strong></td>

                <td width="15%" align="center" class="labeltxt"><strong>Total Miles</strong></td>
              ...
              <tr>
                ...
                <td align="center" valign="middle">{$data[q].user}</td>

                <td align="center" valign="middle">{$data[q].clinic}</td>

                <td align="center" valign="middle">{$data[q].pck_add}</td>

                <td align="center" valign="middle">{$data[q].drp_add} </td>

                <td align="center" valign="middle">{$data[q].miles} </td>
