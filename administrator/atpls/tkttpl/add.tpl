        ...
        <td height="44" align="center"  valign="top" style="padding-bottom:50px;"><form name="addvehicle" id="addvehicle" method="post" action="add.php">
          ...
          <table width="80%" border="0" cellspacing="2" cellpadding="2" align="center">
            ...
            <tr>
              ...
              <td colspan="2" align="left"><input type="text" name="tck_num" id="tck_num" value="{$tck_num}"  class="validate[required] inputTxtField"/>
            ...
            <tr>
              ...
              <td colspan="2" align="left"><input type="text" name="date" id="date" value="{$date}" maxlength="15" class="validate[required] inputTxtField" />
            ...
            <tr>
              ...
              <td colspan="2" align="left"><input type="text" name="reason" id="reason" value="{$reason}" class="validate[required] inputTxtField" maxlength="200" />
            ...
            <tr>
              ...
              <td colspan="2" align="left"><input type="text" name="cost" id="cost" value="{$cost}" class="validate[required,custom[onlyNumber]] inputTxtField digit" maxlength="5" />
