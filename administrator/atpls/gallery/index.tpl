    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>  <td height="19" align="center" class="admintopheading">OUR GALLERY </td>   </tr>
              <tr>
                <td height="44" align="center"  valign="top" style="padding-bottom:20px;"><table width="100%" border="0" class="main_table">
                    <tr>
                      ...
                      <td width="30%" align="left" class="label_txt_heading"><strong>Image Title</strong></td>
                      <td width="55%" align="left" class="label_txt_heading"><strong>Images</strong></td>
                    ...
                    <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
                      ...
                      <td align="left" valign="middle">{$gallery[q].title}</td>
                      <td align="left" valign="middle">
					   <img border="0" src="../../{$gallery[q].image}" width="50px" height="50px">
					  </td>
                      <td align="center" valign="middle">
                     {if $smarty.session.admuser.admin_level eq '0' || $smarty.session.adminpermission.m13m_dl eq 'on' }{/if}
                      <a href="edit.php?eId={$gallery[q].id}" title="Edit"> <img border="0" alt="Edit" src="../graphics/edit.png"></a>&nbsp;&nbsp;<a href="#" onclick="return deleteRec('{$gallery[q].id}');" title="Remove"><img alt="Remove" border="0"  src="../graphics/delete.png"></a></td>
                    </tr>{sectionelse}
