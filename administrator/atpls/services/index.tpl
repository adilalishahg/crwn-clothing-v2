    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>  <td height="19" align="center" class="admintopheading">SERVICES </td>   </tr>
              <tr>
                <td height="44" align="center"  valign="top" style="padding-bottom:20px;"><table width="100%" border="0" class="main_table">
                    <tr>
                      ...
                      <td width="30%" align="left" class="label_txt_heading"><strong>Services</strong></td>
                      <td width="55%" align="left" class="label_txt_heading"><strong>Contents</strong></td>
                    ...
                    <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
                      ...
                      <td align="left" valign="middle">{$admdetail[q].content|truncate:100}</td>
