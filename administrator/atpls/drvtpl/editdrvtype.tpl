...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr>
	...
	<form name="editdrvtype" id="editdrvtype" method="post" action="editdrvtype.php?id={$id}">
								...
								<table width="650" border="0" cellspacing="2" cellpadding="2">
								  ...
								  <tr>
									...
									<td width="74%" height="25"><input name="drvtype" type="text" class="validate[required,custom[onlyLetter]]" id="drvtype" value="{$drvtype}" maxlength="15"  />

								    <span class="estaric">*</span>									  <input type="hidden" name="hiddrvtype" id="hiddrvtype" value="{$hiddrvtype}" /></td>
