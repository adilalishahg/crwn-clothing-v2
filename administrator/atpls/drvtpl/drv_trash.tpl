        ...
        <td height="44" align="center"  valign="top"><table width="100%" border="0" class="main_table">
                ...
                {section name=q loop = $vehtypedetails}
				  ...
				  <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
                    ...
                    <td align="center" valign="middle">{$vehtypedetails[q].fname} {$vehtypedetails[q].fname}</td>
					...
					<a href="#" title="Restore Driver Type"  onClick="return restore('{$vehtypedetails[q].Drvid}');"> 

					<img border="0" alt="Restore" src="../graphics/restore.png"></a>&nbsp;&nbsp;

                    <a href="#" onClick="return deleteRec('{$vehtypedetails[q].Drvid}');" title="Remove"> 
