        ...
        <tr>
          <td height="44" colspan="2" align="center"  valign="top"><table width="100%" border="0" class="main_table">
              <tr>
                ...
                <td  align="center" class="label_txt_heading"><strong>License #</strong></td>
              ...
              <tr valign="top" bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
                ...
                <td align="center">{$drvdetails[q].license}</td>
                <td align="center">{$drvdetails[q].name}  {if $drvdetails[q].modiv_flage eq '1'}<img style="margin-top: -11px;" border="0" width="60" height="30" title="ModivCare" alt="ModivCare" src="../graphics/modiv30.svg" />{/if}</td>
