...
<table width="100%" border="0" cellpadding="4" cellspacing="0">
        ...
        <tr>
          <td class="admintopheading">Testimonial Description</td>
          </tr>
        <tr>
          <td align="left" valign="top">
  ...
  <tr>
    ...
    <td align="left" valign="top"><form name="editPage" id="editPage" method="post" action="editpage.php?eId={$eId}">
							  <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                  ...
                                  <tr>
									<td height="25" class="labeltxt" align="right"><strong>Name:</strong></td>
									<td width="76%" class="labeltxt" height="25">{$data[0].fname}</td>
								  </tr>
                                 <tr><td>&nbsp;</td></tr> 
								   <tr>
									<td height="25" align="right" valign="top" class="labeltxt"><strong>Message:</strong></td>
									<td height="25">{$data[0].message}</td>
								  </tr>
								  <tr>
