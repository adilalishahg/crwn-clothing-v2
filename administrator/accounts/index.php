...
// Fetch all categories list
   ...
   // Footer paging
	 ...
	 $Queryhosp1 = "SELECT ac.id,ac.account_name FROM ".accounts." ac  WHERE TRIM(LOWER(REPLACE(account_name,' ',''))) IN('logisticcare','logisticare','modivcare') ORDER BY ac.account_name ASC";
