...
{*/
	...
	{
		$id = $_GET['resid'];
		$queryRestore = " Update ".TBL_VEHTYPES." SET
																del = '0',
																del_by = '',
																del_date = ''
											where  id = '$id'";
		...
		{  
			...
			echo "<script>location.href= 'vtype_trash.php';</script>";
		}
...
//}
	...
	else
	{
	 ...
	 $Querypg = "SELECT COUNT(*) FROM ".TBL_VEHTYPES." Where del = '1'  $whr" ;	
	...
	$Query2 = "SELECT * FROM ".TBL_VEHTYPES." Where del = '1'  $whr LIMIT ".$pagination->startRow . ",".$pagination->maxRows;
	...
	$smarty->display('vehtpl/vtype_trash.tpl');
