<?php
	...
	$db->connect();
   $id=$_REQUEST['id'];
	 $Query = "SELECT td.tripassign_time,td.driverconfirm_time,td.arrived_time,td.picked_time, td.trip_id,t.trip_code,t.trip_user,t.trip_clinic,t.trip_tel,td.pck_add,td.drp_add,td.pck_time,td.aptime,td.drp_atime,td.drp_time,td.trip_miles
,td.drv_id,td.status,td.trip_remarks,td.wc,td.picklocation,td.droplocation,td.ac_noshowcancell FROM trip_details td, trips t  
   ...
   $smarty->assign("status",$trip_status);
	...
	$smarty->display('rpaneltpl/view_grid.tpl');
?>