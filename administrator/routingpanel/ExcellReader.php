...
class OLERead {
	...
	function __readData($bl) 	// Reads the data from Excell file!
...
//     M Y  E X C E L L   T O   A R R A Y    F U N C T I O N  //	

	function xlsToArray($row_numbers=false,$col_letters=false,$sheet=0,$table_class='excel') 

	{

		$ext='';

		for($row=3;$row<=$this->rowcount($sheet);$row++) 

		{
...

			{
...

				{
					...
					$ext[$row-3][$col-1] = $this->val($row,$col,$sheet);
