...
//-------------------------------- page code -------------------------------------------//
...

	{
		...
		$sdate =/*convertDateToMySQL(sql_replace($_REQUEST['startdate']))*/sql_replace($_REQUEST['startdate']);

		$edate = /*convertDateToMySQL(sql_replace($_REQUEST['enddate']))*/sql_replace($_REQUEST['enddate']);
...
$qUsers = "SELECT  admin_name, admin_lname, admin_id FROM ".TBL_ADMIN;
...
$url ="MMTp://".$_SERVER['MMTP_HOST'].$_SERVER['REQUEST_URI'];
