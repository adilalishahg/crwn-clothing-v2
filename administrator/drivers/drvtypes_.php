...
// Delete Vehicle Script
	...
	$maxRecord = 20; 
	 ...
	 $Querypg = "SELECT COUNT(*) FROM ".TBL_DRVTYPES;	
...
$drvqdetails = array();
 ...
 for($i=0; $i<sizeof($drvdetails); $i++){
	$Query3 = "SELECT COUNT(*) AS trows FROM ".TBL_DRVTYPES.",".TBL_DRIVERS." WHERE drvtype=".TBL_DRVTYPES.".dtype_id AND ".TBL_DRVTYPES.".dtype_id='".$drvdetails[$i]['dtype_id']."' GROUP BY ".TBL_DRIVERS.".Drvid";
