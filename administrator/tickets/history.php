...
// Fetch all vehicles list
	 $Querypg = "SELECT COUNT(*) FROM ".TBL_TCKT." WHERE drv_id=".$id;	
	...
	$Query2 = "SELECT * FROM ".TBL_TCKT." WHERE drv_id=".$id." ORDER BY date DESC LIMIT ".$pagination->startRow . ",".$pagination->maxRows;
