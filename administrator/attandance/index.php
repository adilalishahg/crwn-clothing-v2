...
if($drv_id!=''){$whr .= " AND at.driver_id = '".$drv_id."'"; $ord=" ORDER BY at.dated ASC";}else{$ord=" ORDER BY dr.fname ASC";}

if($whr!=''){
		$Qs="SELECT at.*,dr.fname,dr.lname FROM attendance as at LEFT JOIN drivers as dr on at.driver_id=dr.Drvid $whr $ord";
