 ...
 * Created By   : Imran Farooq

 * Dated        : 11-Sep-2008

 * Modified By  : Imran Farooq

 * Modify Date  : 06-Oct-2008  
...
function display_pagination(){
	...
	if($this->totalRows>$this->maxRows){
		...
		$this->outPutString.=' <a class="SignUp" href="'.$url.'&pageNum=0">[First]</a>&nbsp;'; 
		...
		$this->outPutString.='<a class="SignUp" href="'.$url.'&pageNum='.max(0, $this->pageNum - 1).'">[Previous]</a>';
		...
		'<a class="SignUp" href="'.$url.'&pageNum='.$i.'">'.($i+1).'</a>&nbsp;';
		...
		$this->outPutString.='&nbsp;<a class="SignUp" href="'.$url.'&pageNum='.min($this->totalPages, $this->pageNum + 1).'">[Next]</a>&nbsp;';
		...
		$this->outPutString.='<a class="SignUp" href="'.$url.'&pageNum='.($this->totalPages-1).'">[Last]</a>&nbsp';
