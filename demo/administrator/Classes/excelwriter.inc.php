<?php
...

	{
		...
		*/
		...
		function ExcelWriter($file="",$SheetName)

		{

			return $this->open($file,$SheetName);
		...
		*/
...

		{
...

			{
			  ...
			  $this->fp=fopen($file,"a") or die('unable to open file for appending');
			...
			fwrite($this->fp,$this->GetHeader($SheetName));
...
EOH;
		...
		*/
...

		{
			...
			foreach($line_arr as $col)
				...
				fwrite($this->fp,"<td class=xl25 width=115 >$col</td>");
		...
		*/
		...
		if($this->state!="OPENED")
			...
			fwrite($this->fp,"<x:Name>");
			fwrite($this->fp,"12313");
		...
		*/
...

		{
			...
			fwrite($this->fp,"<td class=xl24 width=115>$value</td>");
