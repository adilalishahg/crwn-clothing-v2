...
<table width="500" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
			  ...
			  <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left" valign="middle"><span class="SmallnoteTxt">
                    ...
                    <input name="date" type="text"  class="validate[required] inputTxtField" id="date" value="{$date}" />
  ...
  <tr>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left" valign="middle"><input name="cost" type="text"  class="validate[required,custom[onlyNumber]] inputTxtField digits" id="cost" value="{$cost}" maxlength="6"/>
