	...
	<form name="editmentype" id="editmentype" method="post" action="edit_type.php">
								...
								<table width="650" border="0" cellspacing="2" cellpadding="2">
								  ...
								  <tr>
									...
									<td width="74%" height="25"><input name="mentype" type="text" class="validate[required,custom[onlyLetter]] inputTxtField" id="mentype" value="{$mentype}" maxlength="50"  />

								    *

								    <input type="hidden" name="hidmentype" id="hidmentype" value="{$hidmentype}" />
