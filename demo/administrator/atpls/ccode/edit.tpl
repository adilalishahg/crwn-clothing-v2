              ...
              <tr>
                <td height="44" align="center"  valign="top" style="padding-bottom:20px; color: #F00;"><form name="add-admuser" id="add-admuser" method="post" action="">
                    ...
                    <tr>
                      ...
                      <td width="80%" height="25"><input name="company" type="text" class="validate[required]" id="company" value="{$data.company}" maxlength="200" size="50" />*<br/><div id='dupcode'></div></td>
                    </tr>
                     <tr>
                      <td  height="25" align="right" class="labeltxt"><b>Code:</b></td>
                      <td  height="25"><input name="code" type="text" class="validate[required]" id="code" value="{$data.code}" maxlength="350"  size="50" />*</td>
                    </tr>
                     <tr>
