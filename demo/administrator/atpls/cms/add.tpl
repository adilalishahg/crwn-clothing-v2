    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="19" align="center" class="admintopheading">Add New Question</td>
              </tr>
              <tr>
				...
				<form name="add-admuser" id="add-admuser" method="post" action="" enctype="multipart/form-data">
                    ...
                    <tr>
                      <td width="10%" height="25" align="right" class="labeltxt"><b>Page Title:</b></td>
                      <td width="90%" height="25"><input name="title" type="text" class="validate[required]" id="title" value="{$post.title}"  size="100"/>*</td>
                    </tr>
                    <tr>
                      <td width="10%" height="25" align="right" class="labeltxt"><b>Page Name:</b></td>
                      <td width="90%" height="25"><input name="name" type="text" class="validate[required]" id="name" value="{$post.name}"  size="100"/>*</td>
                    </tr>
					<!---
                    <tr>
                      <td  height="25" align="right" class="labeltxt"><b>Image:</b></td>
                      <td  height="25"><input type="file" name="img[]"  /></td>
                    </tr>
					-->
                    <tr>
                      <td  height="25" align="right" class="labeltxt"><b>Page Content:</b></td>
                      <td  height="25"> <textarea class="content" id="content" style="width: 100%; height: 500px" name="content" >{$post.content}</textarea></td>
                    </tr>
                                                                                     </table></td>
