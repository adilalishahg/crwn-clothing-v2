...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
							  ...
							  <form name="edit-admuser" id="edit-admuser" method="post" action="editprg.php?eId={$eId}">
      ...
      *</td>
      ...
      <tr>
        ...
        <tr>
		  ...
		  <select name="prgstatus" id="prgstatus" class="validate[required]">
        ...
        <tr>
		  ...
		  <input type="submit" name="admusersub" id="admusersub" value="Edit Program Type" class="btn" />
