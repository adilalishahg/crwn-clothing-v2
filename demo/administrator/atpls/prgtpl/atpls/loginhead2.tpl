...
<body bgColor=#FFFFFF leftMargin=0 topMargin=0 marginWidth=0 marginHeight=0 onLoad="MM_preloadImages('images/login_15.gif','images/login_button_r.gif','images/reset_button_r.gif')">
...
<img src="images/login_01.gif" width=1004 height=99 alt=""></td>
