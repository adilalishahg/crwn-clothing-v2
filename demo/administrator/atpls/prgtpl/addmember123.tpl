...
<script type="text/javascript">
	function funcOne()
	{
		...
		if(document.addcoupon.couptype[1].checked==true)
			document.addcoupon.specifictime.disabled=false;
		else
			document.addcoupon.specifictime.disabled=true;
	}
	
	function funcTwo()
	{
		
		if(document.addcoupon.coupamount[0].checked==true)
		{
			document.addcoupon.camount.disabled=false;
			document.addcoupon.cpercent.disabled=true;
			
		}
		else
		{
			document.addcoupon.camount.disabled=true;
			document.addcoupon.cpercent.disabled=false;
...
{/literal}
        ...
        <tr>
          <td  class="admintopheading">Add Member </td>
          </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
		  ...
		  <form name="affregister" id="affregister" method="post" action="addmember.php">
