...
<body>
<form name="updReq" id="updReq" action="corporaterequest_1.php" method="post">
	...
	<div id="main_container">
    	...
    	<div id="inner_container">
        	<table cellpadding="0" cellspacing="0"  width="100%">
				...
				<option value="roundtrip" {if $smarty.session.triptype eq 'roundtrip'}selected{/if} selected>Round Trip</option>

				<option value="oneway" {if $smarty.session.triptype eq 'oneway'}selected{/if}>One Way</option>
                                                ...
                                                <!--<tr>
                                                    ...
                                                    <td>
              		<select name="progtype" class="txt_box required" id="progtype" onchange="return chProg(this.value);" >
	    <option value="">Select</option>
						<option value="1" {if $smarty.session.progtype eq '1'}selected{/if}>A.H.C.C.C.S</option>
			 </select>
                                                    </td>
                                                    <td></td>
                                                </tr>-->
                                                <tr>
                                                    ...
                                                    <td>
                                                    	 <select name="vehtype" class="txt_box required" id="vehtype" >

			    <option value="">Select</option>

			  {section name=q loop=$vehiclepref}	

				<option value="{$vehiclepref[q].id}" {if $smarty.session.vehtype eq $smarty.session.vehtype}selected{/if}>{$vehiclepref[q].vehtype}</option>
			  ...
			  {/section}
                                                   ...
                                                   <!--<tr>
                                                	<td colspan="3"><div class="form_heading">Client Information</div></td>                                                </tr>
                                                 <tr>
			 ...
			 <input type="text" name="cisid" id="cisid" value="{$cisid}" class="txt_box required" />&nbsp;<span class="SmallnoteTxt">*</span></span>  <span id="ssnsp" {if $progtype eq '1'}style="display:block;"{else}style="display:none;"{/if}>

			 <input type="text" name="ssn" id="ssn" value="{$ssn}" class="txt_box"   />&nbsp;<span class="SmallnoteTxt">*</span></span></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="appdate" id="appdate" value="{$smarty.session.appdate}" class="txt_box required date" />                
              ...
              <span class="SmallnoteTxt">* (mm/dd/yy e.g: 09/14/1983)</span>	</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="apptime" id="apptime" value="{$smarty.session.apptime}" class="txt_box required"  maxlength="5" onblur="return tValid(this.value,'apptime');"/>
            ...
            <tr id="rpu">
			  ...
			  <select name="puchoice" id="puchoice" class="txt_box required" onchange="return pUchoice(this.value);" >

			     <option value="" {if $smarty.session.pickupchoice eq ''}selected{/if}>Select</option>

				 <option value="Will Call" {if $smarty.session.pickupchoice eq 'Will Call'}selected{/if}>Will Call</option>

				 <option value="Time" {if $smarty.session.pickupchoice eq 'Time'}selected{/if}>Time</option>
           ...
           <tr id="rpTime" style="display:none;">
              ...
              <td colspan="2"><input type="text" name="returnpickup" id="returnpickup" value="{$smarty.session.returnpickup}" class="txt_box required" maxlength="5" onblur="return tValid(this.value,'returnpickup');" />
           ...
           {/if} 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input  type="text" name="casemanager1" id="casemanager1" value="{if $smarty.session.casemanager1 eq ''}{if $smarty.session.allowUser eq 0}{$smarty.session.user.fname} {$smarty.session.user.lname}{/if}{else}{$casemanager1}{/if}"  class="txt_box required"  />&nbsp;<span class="SmallnoteTxt">*</span></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td><input type="text" name="pickaddress" id="pickaddress" value="{$smarty.session.pickaddress}" class="txt_box required" abindex="12" maxlength="150" /></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                	<td class="label">Destination:</td>
                                                    <td><input type="text" name="destination" id="destination" value="{$smarty.session.destination}"  class="txt_box required" maxlength="150"  />&nbsp;<span class="SmallnoteTxt">*</span></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                	<td class="label" id="b1">Back To:</td>
                                                    <td><span id="trBackTo2"><input type="text" name="backto" id="backto" value="{$smarty.session.backto}"  class="txt_box required" />&nbsp;<span id="b2" class="SmallnoteTxt">*</span></span></td>
                                                    <td></td>
                                                </tr>
                                                 <tr>
                                                	<td ></td>
                                                    <td style="text-align:right;"><input type="submit" value="Proceed..." id="submit" name="submit" class="btn">	<!--<a href="#"><img src="images/proceed_btn.png" alt="" border="0" /></a>-->
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            </table>
