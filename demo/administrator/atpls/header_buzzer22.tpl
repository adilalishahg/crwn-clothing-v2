...
<div id="content_wrapper">
        ...
        <a href="../Corporates/casemanagers.php">Case Manager</a>
        <a href="../Corporates/addcm.php">Add Case Manager</a>
		</div>
		{/if}
	   ...
	   {if $smarty.session.admuser.admin_level eq '0'}			
		...
		<div class="menu_body">
		 <a href="../reports/index.php">HTT-1 Report</a>
         <a href="../reports/rep_HTT3.php">HTT-3 Report</a>
		</div>
	   {if $smarty.session.admuser.admin_level eq '0'}					
