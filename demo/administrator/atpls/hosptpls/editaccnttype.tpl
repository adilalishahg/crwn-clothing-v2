...
<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
        ...
        <tr>
          ...
          <td class="admintopheading">Edit Account Type </td>
  ...
  <tr>
	...
	<form name="editvehtype" id="editvehtype" method="post" action="editaccnttype.php?id={$id}">
								...
								<table width="650" border="0" cellspacing="2" cellpadding="2">
								  ...
								  <tr>
								    ...
								    <span class="est">*</span>									  <input type="hidden" name="hidvehtype" id="hidvehtype" value="{$hidvehtype}" /></td>
