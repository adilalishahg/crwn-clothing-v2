...
<table border="0" cellspacing="1" cellpadding="1" width="100%">
      <tr >
        <td class="tde" colspan="2"  valign="top"><p class="style4">&nbsp; <a href="http://{$contact.0.url}"><img src="../images/logo.png" border="0" style="max-height:70px;max-width:70px;"></a></td>
...
<tr><td colspan="6" style="height:20px;"></td></tr>
<tr><td width="140" class="headus">Client Name:</td><td class="val">{$data.0.clientname}</td><td width="140" class="headus">Account Name:</td><td class="val">{$data.0.account_name}</td></tr>
  ...
  <tr></tr>
      ...
      <tr>
        <td colspan="8"><table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <tr><td height="25" align="left" class="labeltxt" width="15%">Leg ID:</td>
            <td height="25" align="left" class="labeltxt" width="35%">{$data[0].ccode}</td></tr>
            <tr>
