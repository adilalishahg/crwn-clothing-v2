...
<td height="19" colspan="2" align="center" class="admintopheading">PAYMENT REPORT</td>
           ...
           <td width="31%" align="left" valign="top"><input type="text" name="startdate" id="startdate" value="{$startdate}" class="inputTxtField"/>                &nbsp;
  ...
  &nbsp;				</div>
              ...
              <td width="40%" align="left" valign="top"><input type="text" name="enddate" id="enddate" value="{$enddate}" class="inputTxtField" />
            ...
            <tr>
              ...
              <option value="approved" {if $request_status eq 'approved'} selected="selected" {/if} >Approved</option>
              <option value="disapproved" {if $request_status eq 'disapproved'} selected="selected" {/if}>Disapproved</option>			              <option value="active" {if $request_status eq 'active'} selected="selected" {/if}>Pending</option>
              </select></td>
           </tr>
          		<tr>
     	 ...
     	 <td align="left" valign="top"><input type="text" name="pname" id="pname" value="{$pname}" class="inputTxtField" autocomplete="off"  onKeyUp="searchSuggest();" /><div id="layer1"></div> </td>
              ...
              <td align="left" valign="top" class="labeltxt">&nbsp;</td>
              <td width="40%" align="left" valign="top"><select name="payment_status" ><option value="" {if $payment_status eq ''} selected="selected" {/if} >All</option><option value="0" {if $payment_status eq '0'} selected="selected" {/if} >Pending</option><option value="1" {if $payment_status eq '1'} selected="selected" {/if} >Collected</option></select></td>
			</tr>
            <!--<tr>
              <td align="left" valign="top" class="labeltxt"></td>
...
<td width="15%" align="center"><strong>{if $showClient eq 'no'}Client{else}Client Name{/if}</strong></td>
<td width="15%" align="center"><strong>{if $showClient eq 'no'}Contact Person{else}Appt Date /Time{/if}<br/>Account Name</strong></td>
