...
<table id="table1" class="outer_table"   border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF" style="margin-bottom:10px;">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td height="19" align="center" class="admintopheading">Update Service</td>
		</tr>
        <tr>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="2">
		...
		<tr>
			...
			<td width="90%" height="25"><input name="title" type="text" class="validate[required]" id="title" value="{$gallery.title}" maxlength="500" size="50"/>*</td>
		</tr>
                     ...
                     <tr>
                      ...
                      <td  height="25"><img src="../../{$gallery.image}" height="50" width="50"  /></td>
                    </tr>
					<!--
                     <tr>
                      <td  height="25" align="right" class="labeltxt"><b>Content</b></td>
                      <td  height="25"> <textarea class="content" id="content" style="width: 100%; height: 500px" name="content" >{$gallery.image}</textarea></td>
                    </tr>
					-->
					<!--
                    <tr>
                      <td  height="25" align="right" class="labeltxt"><b>Excerpt</b></td>
                      <td  height="25"> <textarea class="excerpt" id="excerpt" style="width: 100%; height: 150px" name="excerpt" >{$data.excerpt}</textarea></td>
                    </tr>
					-->
                                                                                     </table></td>
                      ...
                      <td colspan="3" align="center" valign="top">
                        ...
                        <input type="hidden" name="thumb" value="{$data.thumb}"  /></td>
                      </tr>
                      <tr>
