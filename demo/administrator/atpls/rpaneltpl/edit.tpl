        ...
        <tr>
          ...
          <td align="left" valign="top" width="100%"><form name="addgrid" id="addgrid" method="post" action="editgrid-new.php?type={$type}" enctype="multipart/form-data" >
              <table width="650" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr>
                  <td width="150" height="25" align="right" class="labeltxt">Client: </td>
                  ...
                  <td height="25"><select name="account" class="required"><option value="">Select Account</option>{section name=q loop=$accounts}
                  <option value="{$accounts[q].id}" {if $accounts[q].id eq $account} selected {/if}>{$accounts[q].account_name}</option>{/section}</select>         <span style="color:#FF0000"> * </span></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="25" align="right" class="labeltxt">Pickup Location: </td>
                  <td height="25"><textarea name="picklocation" id="picklocation" cols="35" class="">{$picklocation}</textarea>
                    <span style="color:#FF0000">  </span></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="25" align="right" class="labeltxt">Drop Location: </td>
                  <td height="25"><textarea name="droplocation" id="droplocation" cols="35" class="">{$droplocation}</textarea>
                    <span style="color:#FF0000">  </span></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td height="25"> {if $smarty.session.admuser.admin_level eq '0'}{else} {/if}
                    ...
                    or
                    <input  type="checkbox" name="pck_wc"  id="pck_wc" onClick="chkwc();" {if $wc eq "1"} checked="checked" {/if} /> W/C
