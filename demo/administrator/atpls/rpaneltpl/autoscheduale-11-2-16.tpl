...
if(noftrips > 0){ 
	 $.post("doautoscheduale.php", {noftrips: ""+noftrips,date: ""+date}, function(data){
		 if(data.length > 0 ){  //alert(data); return false;
...
<style type="text/css" >
.btn_main{width:435px; margin:auto;}
...
<table width="450" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="left" class="driver_num">{$tot_trips}</td>
  </tr>
  <tr>
    <td width="229" height="28" class="driver_head">Total Number of Assign Trips:</td>
    <td align="left" class="driver_num">{$tot_assign_trips}</td>
  </tr>
  <tr>
    <td width="229" height="28" class="driver_head">Total Number of Un-assign Trips:</td>
    <td align="left" class="driver_num">{$tot_unassign_trips}</td>
  </tr>
</table>

</div>
<a {if $tot_availble_drivers gt 0} href="#" onclick="autoSCH();" {else}  href="#" onclick="alert('Before starting Auto Schedual,  Please select some drivers');" {/if} > <div class="verti_bg">
Start<br/ > Auto<br/ > 
Schedule
</div>
</a>
