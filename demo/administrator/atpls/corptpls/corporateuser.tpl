...
<tr>
							...
							[<a href="javascript:history.back();">Back</a>]| <a title="Add" href="addcu.php">
				...
				{/section}
                            ...
                            <tr>
                              <td height="19" colspan="2" align="center" class="admintopheading">CORPORATE USER MANAGEMENT</td>
                            </tr>
                  ...
                  <tr>
                    ...
                    <td width="25%" align="center" class="label_txt_heading"><strong>Corporation</strong></td>
                ...
                {section name=q loop=$cm}
				  <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
					...
					<a href="editcu.php?id={$cm[q].cm_id}" title="Edit"> 
