...
{/literal}
<table width="700" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center" class="outer_table" style="margin-bottom:10px;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td height="19" align="center" class="admintopheading">Edit Corporate User</td>
...
{ if $msgs != '' }<font color="#009966" style="font-weight:bold">{$msgs}</font>{/if}
	  ...
	  <table width="80%" border="0" cellspacing="2" cellpadding="2" align="center">
            ...
            <tr>
              ...
              <td align="left" valign="top" class="labeltxt"><strong>Corporation Name:</strong></td>
