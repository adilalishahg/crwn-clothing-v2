        ...
        <tr>
          ...
          <td align="left" valign="top" width="100%"><form name="editvehtype" id="editvehtype" method="post" action="editvehtype.php?id={$id}">
              <table width="650" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr>
                <td width="26%" height="25" align="right" class="labeltxt"><strong>0-3 Miles Charges:</strong></td>
                <td width="70%" height="25"><input name="rate3" type="text" class="" id="rate3" value="{$data.rate3}" maxlength="10"  />
                  &nbsp;<span class="est">* </span>&nbsp;</td>
              </tr>
              <tr>
                <td width="26%" height="25" align="right" class="labeltxt"><strong>4-6 Miles Charges:</strong></td>
                <td width="70%" height="25"><input name="rate6" type="text" class="" id="rate6" value="{$data.rate6}" maxlength="10"  />
                  &nbsp;<span class="est">* </span>&nbsp;</td>
              </tr>
              <tr>
                <td width="26%" height="25" align="right" class="labeltxt"><strong>7-10 Miles Charges:</strong></td>
                <td width="70%" height="25"><input name="rate10" type="text" class="" id="rate10" value="{$data.rate10}" maxlength="10"  />
                  &nbsp;<span class="est">* </span>&nbsp;</td>
              </tr>
                 <tr>
                  <td width="26%" height="25" align="right" class="labeltxt"><strong>After 10 Miles Charges:</strong></td>
                  <td width="74%" height="25"><input name="permile_ch" type="text" class=" " id="permile_ch" value="{$permile_ch}" maxlength="10"  />
                    <span class="est">*</span></td>
                </tr>
                <!--<tr>
                ...
                <tr>
                  ...
                  <td width="74%" height="25"><input name="afterhour_ch" type="text" class=" " id="afterhour_ch" value="{$afterhour_ch}" maxlength="10"  />
                    <span class="est">*</span></td>
                </tr>
                <!--<tr>
