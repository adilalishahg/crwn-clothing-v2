<?php /* Smarty version 2.6.12, created on 2019-04-24 15:02:24
         compiled from rpaneltpl/edit2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpaneltpl/edit2.tpl', 2040, false),)), $this); ?>
...
" class="txt_box required" tabindex="4" />
...
" <?php endif; ?> class="txt_box" tabindex="6" maxlength="15" />
    ...
    <tr>
      ...
      <td colspan="2"><input type="text" name="po" id="po" value="<?php echo $this->_tpl_vars['tripdata']['0']['po']; ?>
"/>
     ...
     <tr>
                  ...
                  <td colspan="2" align="left"><input type="text" name="claim_no" id="claim_no" value="<?php echo $this->_tpl_vars['tripdata']['0']['claim_no']; ?>
" class="txt_box" maxlength="14" />
    ...
    <tr>
      ...
      <td colspan="2"><input type="text" name="patient_weight" id="patient_weight" value="<?php echo $this->_tpl_vars['tripdata']['0']['patient_weight']; ?>
"  />
...
" /></td>
    ...
    <tr>
          ...
          <tr align="left">
            ...
            <span id="legidA" class="labels">Leg-A ID: <input name="legaid" value="<?php echo $this->_tpl_vars['tripdata']['0']['legaid']; ?>
" maxlength="15" /></span>

            <span id="legidB" class="labels" style="display:none">Leg-B ID: <input name="legbid" value="<?php echo $this->_tpl_vars['tripdata']['0']['legbid']; ?>
" maxlength="15"/></span>

            <span id="legidC" class="labels" style="display:none">Leg-C ID: <input name="legcid" value="<?php echo $this->_tpl_vars['tripdata']['0']['legcid']; ?>
" maxlength="15"/></span>

            <span id="legidD" class="labels" style="display:none">Leg-D ID: <input name="legdid" value="<?php echo $this->_tpl_vars['tripdata']['0']['legdid']; ?>
" maxlength="15"/></span>
...
" size="40"  onKeyUp="searchSuggest3();"  autocomplete="off"/>
...
" size="40"   onKeyUp="searchSuggest4();"  autocomplete="off"/>
...
"  class="txt_box"  size="45"  onKeyUp="searchSuggest5();"  autocomplete="off"/>
...
"  class="txt_box"  maxlength="150"  size="45" /></td>
...
"  class="txt_box"  size="45"  onKeyUp="searchSuggest6();"  autocomplete="off"/>
...
" class="txt_box" maxlength="14"  onChange="use_same(this.id);" />
    ...
    <tr id="five1" style="display:none">
      ...
      <td colspan="2"><input type="text" name="five_pickup" id="five_pickup" value="<?php echo $this->_tpl_vars['five_pickup']; ?>
"  class="txt_box " maxlength="5" onBlur="javascript:tValid(this.value,this.id)" />
...
<span class="SmallnoteTxt">*</span>&nbsp;-->Will Call&nbsp;
        ...
        <input type="checkbox" name="five_will_call" id="five_will_call" onClick="check_check5();" <?php if ($this->_tpl_vars['five_will_call'] == 'on'): ?> checked="checked" <?php endif; ?> /></td>
...
?>
        ...
        <option value="<?php echo $this->_tpl_vars['states'][$this->_sections['n']['index']]['abbr']; ?>
" <?php if ($this->_tpl_vars['states'][$this->_sections['n']['index']]['abbr'] == $this->_tpl_vars['five_state']): ?>selected<?php endif; ?>> <?php echo $this->_tpl_vars['states'][$this->_sections['n']['index']]['statename']; ?>
 </option>
...
" size="40"   onKeyUp="searchSuggest7();"  autocomplete="off"/>
...
<td colspan="2"><input type="checkbox" name="escort" value="Yes" <?php if ($this->_tpl_vars['tripdata']['0']['escort'] == 'Yes'): ?> checked="checked" <?php endif; ?>/>&nbsp;Yes</td><td></td></tr>-->
    ...
    <tr>
      ...
      <td colspan="2"><input type="checkbox" name="dstretcher" value="Yes" <?php if ($this->_tpl_vars['tripdata']['0']['dstretcher'] == 'Yes'): ?> checked="checked" <?php endif; ?>/>
...
<td colspan="2"><input type="checkbox" name="bar_stretcher" value="Yes" <?php if ($this->_tpl_vars['tripdata']['0']['bar_stretcher'] == 'Yes'): ?> checked="checked" <?php endif; ?>/>&nbsp;Yes</td><td></td></tr>-->
    ...
    <tr>
      ...
      <td colspan="2"><input type="checkbox" name="dwchair" value="Yes" <?php if ($this->_tpl_vars['tripdata']['0']['dwchair'] == 'Yes'): ?> checked="checked" <?php endif; ?>/>
