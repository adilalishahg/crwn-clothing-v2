<?php /* Smarty version 2.6.12, created on 2019-04-24 16:02:27
...
" size="40" maxlength="50" /></td>
    ...
    <tr>
    <td colspan="2" width="29%" height="25" align="left" class="labeltxt adjust"><b>ZIP : </b><span style="color:#FF0000">*</span><br /><input name="zip" type="text" class="validate[required,custom[],length[0,9]]" id="zip" value="<?php echo $this->_tpl_vars['udata'][0]['zip']; ?>
