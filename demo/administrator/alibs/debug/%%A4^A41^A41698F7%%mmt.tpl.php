<?php /* Smarty version 2.6.12, created on 2019-04-24 15:33:19
         compiled from mercytpl/mmt.tpl */ ?>
<?php echo ' 
...
<form name="addcsv" id="addcsv" method="post" action="mmt.php" enctype="multipart/form-data" onsubmit="return validate(this);" >
...
" <?php if ($this->_tpl_vars['locs'][$this->_sections['n']['index']]['id'] == $this->_tpl_vars['post']['officelocation']): ?>selected<?php endif; ?>> <?php echo $this->_tpl_vars['locs'][$this->_sections['n']['index']]['abrivation']; ?>
