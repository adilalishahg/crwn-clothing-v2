<?php /* Smarty version 2.6.12, created on 2019-04-24 15:21:14
...
"><img src="../images/logo.png" border="0" style="max-height:70px;max-width:70px;"></a></td>
  ...
  <tr></tr>
      ...
      <tr>
        <td colspan="8"><table width="100%" border="0" cellspacing="2" cellpadding="2">
            ...
            <td height="25" align="left" class="labeltxt" width="35%"><?php echo $this->_tpl_vars['data'][0]['ccode']; ?>
</td></tr>
            <tr>
...
<tr>
 ...
 [ <?php echo ((is_array($_tmp=$this->_tpl_vars['data']['0']['tripassign_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
            ...
            <tr>
              ...
              <td height="25"  align="left" class="labeltxt"><?php if ($this->_tpl_vars['data'][0]['pck_time'] == '23:59:59'): ?>Will Call<?php else:  echo $this->_tpl_vars['data'][0]['pck_time'];  endif; ?></td>
